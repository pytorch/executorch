...
from executorch.dev_tools.debug_format.et_schema import OperatorNode
from executorch.dev_tools.etdump.schema_flatcc import ProfileEvent
from executorch.dev_tools.etrecord.tests.etrecord_test import TestETRecord

from executorch.dev_tools.inspector import (
    _inspector,
    Event,
    EventBlock,
    Inspector,
...
from executorch.dev_tools.inspector._inspector import (
    DebugEventSignature,
    flatcc,
    InstructionEvent,
