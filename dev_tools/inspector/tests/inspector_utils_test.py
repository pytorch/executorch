...
from executorch.dev_tools.debug_format.base_schema import (
    OperatorGraph,
    OperatorNode,
    ValueNode,
)

from executorch.dev_tools.debug_format.et_schema import FXOperatorGraph
from executorch.dev_tools.etdump import schema_flatcc as flatcc

from executorch.dev_tools.etrecord.tests.etrecord_test import TestETRecord
from executorch.dev_tools.inspector._inspector_utils import (
