...
inline constexpr bool isBitsType(exec_aten::ScalarType t) {
...
inline constexpr bool isQIntType(exec_aten::ScalarType t) {
...
/* Below series of entries is generated by genScalarTypeTable.py. This
 * is a cost of C++11 support; this could be much more readable with
 * more modern constexpr functions. */
...
struct promote_types {
 private:
  ...
  using promoted_type_not_respecting_half_to_float =
      typename detail::promote_types_lookup<T1, T2>::type;
