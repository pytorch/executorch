...
from executorch.tools.debug_format.et_schema import OperatorGraph, OperatorNode
from executorch.tools.etdump.schema_flatcc import DebugEvent, ETDumpFlatCC, ProfileEvent
from executorch.tools.etrecord import ETRecord, parse_etrecord
