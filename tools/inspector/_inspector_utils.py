...
import executorch.tools.etdump.schema_flatcc as flatcc

import torch

from executorch.tools.debug_format.base_schema import OperatorNode

from executorch.tools.debug_format.et_schema import FXOperatorGraph, OperatorGraph
from executorch.tools.etdump.schema_flatcc import (
    DebugEvent,
    ETDumpFlatCC,
    ProfileEvent,
    ScalarType,
...
from executorch.tools.etdump.serialize import deserialize_from_etdump_flatcc
from executorch.tools.etrecord import ETRecord
