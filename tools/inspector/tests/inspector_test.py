...
from executorch.tools.debug_format.et_schema import OperatorNode
from executorch.tools.etdump.schema_flatcc import ProfileEvent
from executorch.tools.etrecord.tests.etrecord_test import TestETRecord

from executorch.tools.inspector import (
    _inspector,
    Event,
    EventBlock,
    Inspector,
...
from executorch.tools.inspector._inspector import (
    DebugEventSignature,
    flatcc,
    InstructionEvent,
