...
from executorch.tools import generate_etrecord, parse_etrecord

from executorch.tools.debug_format.base_schema import (
    OperatorGraph,
    OperatorNode,
    ValueNode,
)

from executorch.tools.debug_format.et_schema import FXOperatorGraph
from executorch.tools.etdump import schema_flatcc as flatcc

from executorch.tools.etrecord.tests.etrecord_test import TestETRecord
from executorch.tools.inspector._inspector_utils import (
