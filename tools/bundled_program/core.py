...
import executorch.tools.bundled_program.schema as bp_schema
...
from executorch.tools.bundled_program.config import ConfigValue, MethodTestSuite

from executorch.tools.bundled_program.version import BUNDLED_PROGRAM_SCHEMA_VERSION
