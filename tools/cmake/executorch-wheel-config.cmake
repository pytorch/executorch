...
# The same definition the imported targets carry. A consumer on CMake older than
# 3.28 gets no imported targets and links through EXECUTORCH_LIBRARIES instead,
# and without this it could not compile at all: the vendored c10 headers reach
# for a header generated inside a PyTorch build that no wheel can carry.
...
if(_executorch_runtime_library AND NOT _executorch_targets_supported)
  ...
  message(
    STATUS
      ...
      "EXECUTORCH_CXX_STANDARD itself. The prebuilt Python extension is unaffected."
  )
  ...
  if(TARGET executorch::${_component})
    ...
    if(executorch_FIND_REQUIRED_${_component})
      ...
      if(NOT _executorch_targets_supported)
        ...
        # so a consumer who wants them names EXECUTORCH_QUANTIZED_KERNELS_LIBRARY
        # instead. See the OPT_IN comment at the component definition above.
