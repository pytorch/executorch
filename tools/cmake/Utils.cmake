...
function(executorch_target_retain_shared_library target_name library_target)
  ...
  #
  # SHELL form so a comma anywhere in the expanded target file path does not
  # split the option into separate linker arguments. The plain LINKER: form uses
  # commas as separators.
  target_link_options(
    ${target_name}
    PRIVATE
    "LINKER:SHELL:--push-state --no-as-needed $<TARGET_FILE:${library_target}> --pop-state"
  )
