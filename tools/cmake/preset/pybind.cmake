...
if(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
  ...
  # MLX requires Apple Silicon (ARM64) and the Metal compiler (xcrun -sdk macosx metal)
  # which is only available with Xcode, not Command Line Tools
  if(CMAKE_SYSTEM_PROCESSOR STREQUAL "arm64")
    ...
    if(_metal_compiler_result EQUAL 0)
      ...
      message(STATUS "Metal compiler not found, disabling MLX backend. Install Xcode to enable MLX.")
    endif()
  endif()
