...
- (void)testProgramLoad {
    NSURL *modelURL = [[self class] bundledResourceWithName:@"add_all" extension:@"pte"];
...
- (void)testMulProgramExecute {
    NSURL *modelURL = [[self class] bundledResourceWithName:@"mul_all" extension:@"pte"];
    XCTAssertNotNil(modelURL);
    [self executeModelAtURL:modelURL nTimes:10];
}

- (void)testMV2ProgramExecute {
    NSURL *modelURL = [[self class] bundledResourceWithName:@"mv2_all" extension:@"pte"];
    XCTAssertNotNil(modelURL);
    [self executeModelAtURL:modelURL nTimes:10];
}
...
- (void)testMultipleModelExecutionConcurrently {
    NSURL *modelURL1 = [[self class] bundledResourceWithName:@"add_all" extension:@"pte"];
    NSURL *modelURL2 = [[self class] bundledResourceWithName:@"mul_all" extension:@"pte"];
    NSURL *modelURL3 = [[self class] bundledResourceWithName:@"mv2_all" extension:@"pte"];
    NSURL *modelURL4 = [[self class] bundledResourceWithName:@"mv3_all" extension:@"pte"];
...
- (void)testSameModelExecutionConcurrently {
    NSURL *modelURL1 = [[self class] bundledResourceWithName:@"mv3_all" extension:@"pte"];
    NSURL *modelURL2 = [[self class] bundledResourceWithName:@"mv3_all" extension:@"pte"];
