...
class _BasePartitioner(Partitioner):
    ...
    def partition(self, graph_module: EdgeDialectGraphModule) -> EdgeDialectGraphModule:
...
class XnnpackFloatingPointPartitioner(Partitioner):
    ...
    def get_module_partitions(
        self, graph_module: EdgeDialectGraphModule
    ) -> List[List[torch.fx.Node]]:
        """
        Get all partitions in the EdgeDialectGraphModule for the supported
        modules.
        """
    ...
    def generate_partitions(self, graph_module: EdgeDialectGraphModule) -> List[Any]:
        """
        Generate a list of partitions for an EdgeDialectGraphModule.
