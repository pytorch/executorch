...
set(XNNPACK_STATIC_LIB "${CMAKE_CURRENT_BINARY_DIR}/XNNPACK/lib/libXNNPACK.a")
set(XNNPACK_MICROKERNELS_STATIC_LIB
    "${CMAKE_CURRENT_BINARY_DIR}/XNNPACK/lib/libxnnpack-microkernels-prod.a"
)
ExternalProject_Add(
  XNNPACKExternalProject
  SOURCE_DIR ${XNNPACK_SOURCE_DIR}
  # XXX should we install to CMAKE_INSTALL_PREFIX instead? Review how we do it
  # with flatbuffers
  BINARY_DIR ${CMAKE_CURRENT_BINARY_DIR}
  INSTALL_DIR ${CMAKE_CURRENT_BINARY_DIR}/XNNPACK
