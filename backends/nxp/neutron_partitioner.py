...
class NeutronPartitioner(Partitioner):
    def __init__(
        ...
        :param post_quantization_state_dict: Optional dictionary mapping static parameter names to Parameter
                                                      objects containing their data (if they have any). This data is
                                                      extracted from the model right after quantization and before
                                                      edge dialect passes. Therefore, it could potentially be outdated.
        """
        super().__init__()
        ...
        self.neutron_target_spec = neutron_target_spec
        self.post_quantization_state_dict = post_quantization_state_dict or {}
