...
NSYS_CONFIG_PATH = os.path.join(PROJECT_DIR, "backends", "nxp", "tests_models", "neutron-imxrt700.ini")
NSYS_FIRMWARE_PATH = os.path.join(os.path.dirname(eiq_neutron_sdk.__file__), "target", "imxrt700", "cmodel", "NeutronFirmware.elf")
