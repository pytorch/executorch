...
def test_convert_clamp__single_op__no_delegation__relu_variants(min, max):
    # Test that Clamp representable as Relu6 or Relu is NOT delegated, because it is a single op model.
    input_shape = (23,)
...
def test_convert_clamp__single_op__no_delegation__custom_bounds(mocker, min, max):
