...
class TestMaximum:
    ...
    def assert_delegated(
        ...
        graph_verifier = DetailedGraphVerifier(
            mocker,
            expected_delegated_ops=expected_delegated_ops or {Maximum: 1},
    ...
    def assert_not_delegated(self, model, input_shape):
        ...
        assert graph_contains_any_of_ops(delegated_ep.graph, [Maximum])
    ...
    def test__channels_first_input(self, mocker, request, input_spec):
        model = MaxPoolMaximumModule()
        expected_delegated_ops = {Maximum: 1, MaxPool2DWithIndices: 1, GetItem: 1}
