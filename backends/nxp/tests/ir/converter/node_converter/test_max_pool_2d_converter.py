...
@pytest.mark.parametrize("input_shape, padding", [
    ...
    pytest.param((1, 4, 8, 8), (1, 1), id="Padding, keep the same output tensor size as input."),
    pytest.param((1, 4, 8, 8), (1, 0), id="Padding, change the output tensor size."),
    pytest.param((1, 4, 9, 9), (1, 0), id="Padding, change the output tensor size."),
    pytest.param((1, 4, 9, 9), (0, 1), id="Padding, change the output tensor size."),
])
def test_max_pool_2d_conversion(input_shape, padding):
    edge_program = to_edge_program(MaxPool2dModule(padding=padding), input_shape).exported_program()
...
@pytest.mark.parametrize("input_shape, padding", [
    ...
    pytest.param((1, 4, 8, 8), (1, 1), id="Padding, keep the same output tensor size as input."),
    pytest.param((1, 4, 8, 8), (1, 0), id="Padding, change the output tensor size."),
    pytest.param((1, 4, 11, 11), (1, 0), id="Padding, change the output tensor size."),
    pytest.param((1, 4, 11, 11), (0, 1), id="Padding, change the output tensor size."),
])
