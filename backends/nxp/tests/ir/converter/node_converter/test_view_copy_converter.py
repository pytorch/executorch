...
from executorch.backends.arm.constants import exir_ops
...
class ConvViewLinearModule(torch.nn.Module):
    def __init__(self, view_new_shape: list[int], channels: int):
        ...
        self.linear = nn.Linear(view_new_shape[1], 8)
...
def test__context_dependent__channels_first_to_formatless__transpose_fused(mocker):
    input_shape = (1, 2, 3, 4)
    new_shape = [1, 2 * 3 * 4]
    module = ConvViewLinearModule(new_shape, 2)
...
def test__context_dependent__channels_first_to_formatless__transpose_not_fusable():
    input_shape = (1, 2, 3, 4)
    new_shape = [
        2,
        3 * 4,
...
def test__formatless_to_channels_first__transpose_supported(mocker):
    input_shape = (1, 8 * 3 * 8)
    new_shape = [1, 8, 3, 8]
...
def test__formatless_to_channels_first__transpose_not_supported():
    input_shape = (1, 8 * 3 * 4)
...
def test__channels_first_to_channels_first__transpose_supported(mocker):
    input_shape = (1, 8, 3, 8)
    new_shape = [1, 8, 1, 24]
...
def test__channels_first_to_channels_first__transpose_not_supported():
