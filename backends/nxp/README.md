...
As of the analogy of ONNX to LiteRT and Edge to LiteRT conversion, the Neutron Backend's 
currently leverages the Tensor format Inference and LiteRT Optimizer. 
This shall be considered as temporal solution, intended to be replaced with: 
