...
AsStridedCopy = exir_ops.edge.aten.as_strided_copy.default
...
NativebatchNormLegitNoStats = exir_ops.edge.aten._native_batch_norm_legit.no_stats
...
QuantizePerTensorTensor = exir_ops.edge.quantized_decomposed.quantize_per_tensor.tensor
...
SqueezeCopy = exir_ops.edge.aten.squeeze_copy.default
SqueezeCopyDim = exir_ops.edge.aten.squeeze_copy.dim
SqueezeCopyDims = exir_ops.edge.aten.squeeze_copy.dims
