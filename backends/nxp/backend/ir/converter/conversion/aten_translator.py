...
def torch_padding_to_tflite_explicit_padding(torch_padding: list[int]) -> list[list[int]]:
...
def convert_padding(t_padding: list[int]) -> Tuple[tflPadding.Padding, Optional[list[list[int]]]]:
    ...
    if t_padding == [0, 0]:
        ...
        logger.d("Explicit Torch 'padding' cannot be represented directly as 'VALID'. "
