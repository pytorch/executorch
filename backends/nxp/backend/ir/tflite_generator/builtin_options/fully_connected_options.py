...
from executorch.backends.nxp.backend.ir.lib.tflite.FullyConnectedOptionsWeightsFormat import FullyConnectedOptionsWeightsFormat
...
class FullyConnected(meta.BuiltinOptions):
    ...
    def gen_tflite(self, builder: fb.Builder):
        ...
        libFullyConnectedOptions.AddAsymmetricQuantizeInputs(builder, self.asymmetric_quantize_inputs)
