...
from executorch.backends.nxp.backend.ir.tflite_optimizer.graph_utils import NameToTensorMap, operator_is_type
...
class NoFusedActivationFunction(OpRule):
    ...
    def __call__(self, op: tflite_model.Operator, tensor_map: NameToTensorMap, input_to_ops_map: InputTensorToOpsMap,
        ...
        return op.builtin_options.fused_activation_function == ActivationFunctionType.NONE
