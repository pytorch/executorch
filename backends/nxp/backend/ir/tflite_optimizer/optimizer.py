...
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.eliminate_dead_branches import EliminateDeadBranches
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.fuse_activation_functions import FuseActivationFunctions
...
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.fuse_quanitze_into_preceding_ops import FuseQuantizeIntoPrecedingOps
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.keep_one_empty_buffer import KeepOneEmptyBuffer
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.move_relu_before_concat import MoveActivationBeforeConcatenation
...
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.prune_cast_operators import FuseCastOperators, \
    RemoveCastOperatorsWithNoEffect
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.prune_quantize_operators import FuseParallelQuantizeOperators, \
    PruneQuantizeOperators
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.prune_reshape_operators import FuseReshapeOperators, \
    RemoveReshapeOperatorsWithNoEffect
from executorch.backends.nxp.backend.ir.tflite_optimizer.optimizations.prune_transpose_operators import FuseTransposeOperators, \
