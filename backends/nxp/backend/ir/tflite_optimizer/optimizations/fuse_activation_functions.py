...
from executorch.backends.nxp.backend.ir.tflite_optimizer.graph_utils import operator_is_type
from executorch.backends.nxp.backend.ir.tflite_optimizer.operator_rules import NoFusedActivationFunction
...
from executorch.backends.nxp.backend.ir.tflite_optimizer.tensor_rules import TensorHasOneConsumer
...
class FuseActivationFunctions(BaseOptimization):
    ...
    supported_activations_for_op: dict[BuiltinOperator, list[ActivationFunctionType]] = {
        ...
        BuiltinOperator.CONV_3D: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                                  ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/conv3d.cc#L213
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/kernel_util.h#L285-L300

        BuiltinOperator.DEPTHWISE_CONV_2D: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                                            ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/depthwise_conv.cc#L307
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/kernel_util.h#L285-L300

        BuiltinOperator.TRANSPOSE_CONV: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                                         ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/transpose_conv.cc#L516
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/kernel_util.h#L285-L300

        BuiltinOperator.MAX_POOL_2D: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                                      ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/pooling.cc#L247
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/kernel_util.h#L285-L300

        BuiltinOperator.AVERAGE_POOL_2D: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                                          ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/pooling.cc#L124
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/kernel_util.h#L285-L300

        BuiltinOperator.FULLY_CONNECTED: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                                          ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/fully_connected.cc#L627-L630

        BuiltinOperator.ADD: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                              ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/add.cc#L246
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/kernel_util.h#L285-L300

        BuiltinOperator.MUL: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                              ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/mul.cc#L159
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/kernel_util.h#L285-L300

        BuiltinOperator.SUB: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                              ActivationFunctionType.RELU6],
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/sub.cc#L306
        # https://github.com/tensorflow/tensorflow/blob/v2.15.0/tensorflow/lite/kernels/kernel_util.h#L285-L300

        BuiltinOperator.DIV: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                              ActivationFunctionType.RELU6],
        ...
        BuiltinOperator.RNN: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                              ActivationFunctionType.RELU6,
                              ActivationFunctionType.TANH, ActivationFunctionType.SIGN_BIT],
        ...
        BuiltinOperator.UNIDIRECTIONAL_SEQUENCE_RNN: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                                                      ActivationFunctionType.RELU6, ActivationFunctionType.TANH,
        ...
        BuiltinOperator.BIDIRECTIONAL_SEQUENCE_RNN: [ActivationFunctionType.RELU, ActivationFunctionType.RELU_N1_TO_1,
                                                     ActivationFunctionType.RELU6, ActivationFunctionType.TANH,
                                                     ActivationFunctionType.SIGN_BIT]
