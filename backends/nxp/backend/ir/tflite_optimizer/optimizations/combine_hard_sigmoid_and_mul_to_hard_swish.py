...
from executorch.backends.nxp.backend.ir.tflite_generator.builtin_options.hard_swish_options import HardSwish
...
from executorch.backends.nxp.backend.ir.tflite_optimizer.tensor_rules import RuleOr, TensorHasNConsumers, TensorHasStaticValue, \
    TensorHasType, TensorsAreQuantized, TensorsHaveOneConsumer, TensorsHaveType
    ...
    def _combine_quantized_variant(self) -> bool:
        ...
        matcher = PatternMatcher(
            ...
            [
                ...
                TensorsHaveOneConsumer(['mul1_o', 'add_o', 'min_o', 'relu_o', 'quant1_o', 'deq2_o', 'mul2_o']),
                TensorHasStaticValue('alpha', 1 / 6),
                TensorHasStaticValue('beta', 0.5),
                TensorHasStaticValue('one', 1),
