...
@operator_test
class TestConvTranspose3d(OperatorTest):
    @dtype_test
    def test_convtranspose3d_dtype(self, dtype, tester_factory: Callable) -> None:
    ...
    def test_convtranspose3d_basic(self, tester_factory: Callable) -> None:
        # Basic test with default parameters
        self._test_op(Model(), (torch.randn(2, 3, 4, 4, 4),), tester_factory)
        
    def test_convtranspose3d_kernel_size(self, tester_factory: Callable) -> None:
    ...
    def test_convtranspose3d_stride(self, tester_factory: Callable) -> None:
    ...
    def test_convtranspose3d_padding(self, tester_factory: Callable) -> None:
    ...
    def test_convtranspose3d_output_padding(self, tester_factory: Callable) -> None:
        # Test with different output_padding values (requires stride > 1)
        self._test_op(Model(stride=2, output_padding=1), (torch.randn(2, 3, 4, 4, 4),), tester_factory)
        self._test_op(Model(stride=(2, 2, 2), output_padding=(1, 0, 1)), (torch.randn(2, 3, 4, 4, 4),), tester_factory)
        
    def test_convtranspose3d_dilation(self, tester_factory: Callable) -> None:
        # Test with different dilation values
        self._test_op(Model(dilation=2), (torch.randn(2, 3, 4, 4, 4),), tester_factory)
        self._test_op(Model(dilation=(1, 2, 2)), (torch.randn(2, 3, 4, 4, 4),), tester_factory)
        
    def test_convtranspose3d_groups(self, tester_factory: Callable) -> None:
    ...
    def test_convtranspose3d_no_bias(self, tester_factory: Callable) -> None:
        # Test without bias
        self._test_op(Model(bias=False), (torch.randn(2, 3, 4, 4, 4),), tester_factory)
        
    def test_convtranspose3d_channels(self, tester_factory: Callable) -> None:
    ...
    def test_convtranspose3d_different_spatial_dims(self, tester_factory: Callable) -> None:
