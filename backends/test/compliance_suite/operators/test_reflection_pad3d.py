...
@operator_test
class TestReflectionPad3d(OperatorTest):
    @dtype_test
    def test_reflection_pad3d_dtype(self, dtype, tester_factory: Callable) -> None:
    ...
    def test_reflection_pad3d_basic(self, tester_factory: Callable) -> None:
        # Basic test with default parameters
        self._test_op(Model(), (torch.randn(2, 3, 4, 4, 4),), tester_factory)
        
    def test_reflection_pad3d_padding(self, tester_factory: Callable) -> None:
    ...
    def test_reflection_pad3d_input_sizes(self, tester_factory: Callable) -> None:
    ...
    def test_reflection_pad3d_zero_padding(self, tester_factory: Callable) -> None:
    ...
    def test_reflection_pad3d_asymmetric_padding(self, tester_factory: Callable) -> None:
