...
def test_floor_divide_dtype(test_runner, dtype) -> None:
    ...
    test_runner.lower_and_run_model(model, (x, y), generate_random_test_inputs=False)


def test_floor_divide_scalar_divisors(test_runner) -> None:
    ...
    test_runner.lower_and_run_model(
        FloorDivideModel(), (x, y), generate_random_test_inputs=False
    )
...
def test_floor_divide_tensor_divisors(test_runner) -> None:
...
def test_floor_divide_shapes(test_runner) -> None:
...
def test_floor_divide_values(test_runner) -> None:
...
def test_floor_divide_edge_cases(test_runner) -> None:
    # Test edge cases
    model = FloorDivideModel()
