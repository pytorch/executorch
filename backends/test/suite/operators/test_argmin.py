...
def test_argmin_dtype(test_runner, dtype) -> None:
...
def test_argmin_dim(test_runner) -> None:
    test_runner.lower_and_run_model(
        ArgminModel(dim=0),
        (torch.randn(5, 10),),
    )
...
def test_argmin_keepdim(test_runner) -> None:
    test_runner.lower_and_run_model(
...
def test_argmin_shapes(test_runner) -> None:
    test_runner.lower_and_run_model(
        ArgminModel(),
        (torch.randn(20),),
    )
...
def test_argmin_edge_cases(test_runner) -> None:
...
def test_argmin_scalar(test_runner) -> None:
    test_runner.lower_and_run_model(
        ArgminModel(),
        (torch.tensor([5.0]),),
    )
