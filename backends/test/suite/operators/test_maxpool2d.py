...
def test_maxpool2d_dtype(test_runner, dtype) -> None:
...
def test_maxpool2d_kernel_size(test_runner) -> None:
...
def test_maxpool2d_stride(test_runner) -> None:
...
def test_maxpool2d_padding(test_runner) -> None:
...
def test_maxpool2d_dilation(test_runner) -> None:
...
def test_maxpool2d_ceil_mode(test_runner) -> None:
...
def test_maxpool2d_return_indices(test_runner) -> None:
...
def test_maxpool2d_batch_sizes(test_runner) -> None:
...
def test_maxpool2d_input_sizes(test_runner) -> None:
...
def test_maxpool2d_combinations(test_runner) -> None:
