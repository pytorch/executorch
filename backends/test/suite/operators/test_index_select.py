...
def test_index_select_dtype(test_runner, dtype) -> None:
...
def test_index_select_dimensions(test_runner) -> None:
    indices = torch.tensor([0, 2], dtype=torch.int64)
    test_runner.lower_and_run_model(
        IndexSelectModel(dim=0),
...
def test_index_select_shapes(test_runner) -> None:
    indices = torch.tensor([0, 1], dtype=torch.int64)
...
def test_index_select_indices(test_runner) -> None:
