...
def test_avgpool1d_dtype(test_runner, dtype) -> None:
...
def test_avgpool1d_kernel_size(test_runner) -> None:
...
def test_avgpool1d_stride(test_runner) -> None:
...
def test_avgpool1d_padding(test_runner) -> None:
...
def test_avgpool1d_ceil_mode(test_runner) -> None:
...
def test_avgpool1d_count_include_pad(test_runner) -> None:
...
def test_avgpool1d_batch_sizes(test_runner) -> None:
...
def test_avgpool1d_input_sizes(test_runner) -> None:
...
def test_avgpool1d_combinations(test_runner) -> None:
