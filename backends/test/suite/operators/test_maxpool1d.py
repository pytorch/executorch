...
def test_maxpool1d_dtype(test_runner, dtype) -> None:
...
def test_maxpool1d_kernel_size(test_runner) -> None:
...
def test_maxpool1d_stride(test_runner) -> None:
...
def test_maxpool1d_padding(test_runner) -> None:
...
def test_maxpool1d_dilation(test_runner) -> None:
...
def test_maxpool1d_ceil_mode(test_runner) -> None:
...
def test_maxpool1d_return_indices(test_runner) -> None:
...
def test_maxpool1d_batch_sizes(test_runner) -> None:
...
def test_maxpool1d_input_sizes(test_runner) -> None:
...
def test_maxpool1d_combinations(test_runner) -> None:
