...
class GeneratedOpBuilders:
    ...
    def _build_GeluNode(
        ...
        approximate_off = _shared_string(builder, op.approximate)
    ...
    def _build_PadNode(
        ...
        mode_off = _shared_string(builder, op.mode)
    ...
    def _build_BitwiseOrNode(
        self, builder: flatbuffers.Builder, op: BitwiseOrNode
    ) -> Tuple[int, int]:
        """Auto-generated builder for BitwiseOrNode."""
        # Import the MODULE (not class) to access builder functions like Start(), Add*(), End()
        from executorch.backends.mlx.serialization._generated.mlx_delegate import BitwiseOrNode as FBBitwiseOrNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate import OpNode as FBOpNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Tid import CreateTid
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Vid import CreateVid

        FBBitwiseOrNodeModule.Start(builder)
        FBBitwiseOrNodeModule.AddA(builder, CreateTid(builder, op.a.idx))
        FBBitwiseOrNodeModule.AddB(builder, CreateTid(builder, op.b.idx))
        FBBitwiseOrNodeModule.AddOut(builder, CreateTid(builder, op.out.idx))
        offset = FBBitwiseOrNodeModule.End(builder)
        return offset, FBOpNodeModule.OpNode.BitwiseOrNode
    ...
    def _build_IfNode(
        self, builder: flatbuffers.Builder, op: IfNode
    ) -> Tuple[int, int]:
        """Auto-generated builder for IfNode."""
        # Import the MODULE (not class) to access builder functions like Start(), Add*(), End()
        from executorch.backends.mlx.serialization._generated.mlx_delegate import IfNode as FBIfNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate import OpNode as FBOpNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Tid import CreateTid
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Vid import CreateVid

        cond_off = self._build_int_or_vid(builder, op.cond)

        FBIfNodeModule.Start(builder)
        FBIfNodeModule.AddCond(builder, cond_off)
        FBIfNodeModule.AddThenChainIdx(builder, op.then_chain_idx)
        FBIfNodeModule.AddElseChainIdx(builder, op.else_chain_idx)
        offset = FBIfNodeModule.End(builder)
        return offset, FBOpNodeModule.OpNode.IfNode

    def _build_RandomBitsNode(
        self, builder: flatbuffers.Builder, op: RandomBitsNode
    ) -> Tuple[int, int]:
        """Auto-generated builder for RandomBitsNode."""
        # Import the MODULE (not class) to access builder functions like Start(), Add*(), End()
        from executorch.backends.mlx.serialization._generated.mlx_delegate import RandomBitsNode as FBRandomBitsNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate import OpNode as FBOpNodeModule
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Tid import CreateTid
        from executorch.backends.mlx.serialization._generated.mlx_delegate.Vid import CreateVid
        ...
        FBRandomBitsNodeModule.Start(builder)
        FBRandomBitsNodeModule.AddOut(builder, CreateTid(builder, op.out.idx))
        FBRandomBitsNodeModule.AddShape(builder, shape_vec)
        if op.seed is not None:
            FBRandomBitsNodeModule.AddSeed(builder, CreateVid(builder, op.seed.idx))
        FBRandomBitsNodeModule.AddWidth(builder, op.width)
        offset = FBRandomBitsNodeModule.End(builder)
        return offset, FBOpNodeModule.OpNode.RandomBitsNode
    ...
    def _build_MetalKernelNode(
        ...
        name_off = _shared_string(builder, op.name)
        source_off = _shared_string(builder, op.source)
        ...
        header_off = _shared_string(builder, op.header)
