...
def _build_int_or_vid(builder: flatbuffers.Builder, iov: IntOrVid) -> int:
    ...
    from executorch.backends.mlx.serialization._generated.mlx_delegate.Vid import (
        CreateVid,
    )
...
def deserialize_to_json(data: bytes) -> dict:
    ...
    from executorch.backends.mlx.serialization._generated.mlx_delegate.MLXGraph import (
