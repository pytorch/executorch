...
Usage example:
    ...
    python -m executorch.backends.mlx.test.test_linear run

    # Or step by step:
    python -m executorch.backends.mlx.test.test_linear generate
    ./cmake-out-mlx/backends/mlx/test/op_test_runner \\
        --pte backends/mlx/test/op_tests/linear/model.pte \\
        --input backends/mlx/test/op_tests/linear/input.bin \\
        --output backends/mlx/test/op_tests/linear/actual_output.bin
    python -m executorch.backends.mlx.test.test_linear compare
"""
