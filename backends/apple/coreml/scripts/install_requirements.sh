...
# ---------------------------------------------------------------------
# macOS toolchain / SDK setup
# ---------------------------------------------------------------------
if [[ "$(uname)" == "Darwin" ]]; then
    # Prefer existing values if user explicitly set them, otherwise infer via xcrun
    ...
    # Ensure Python extension builds (kmeans1d) see the SDK as well
...
# You can add -G Ninja here if you prefer Ninja
