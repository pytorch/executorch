...
from typing import Callable as _Callable, List as _List, Optional as _Optional

import executorch.backends.apple.coreml.quantizer._coreml_quantizer_utils as _annotation_utils

import torch as _torch

from coremltools.optimize.torch._utils.python_utils import (
    FunctionRegistryMixin as _FunctionRegistryMixin,
)
...
from torchao.quantization.pt2e.quantizer.quantizer import Quantizer as _TorchQuantizer
...
class CoreMLQuantizer(_TorchQuantizer):
    ...
    Example:
            ...
            .. code-block:: python
                ...
                ffrom torchao.quantization.pt2e.quantize_pt2e import convert_pt2e, prepare_qat_pt2e
