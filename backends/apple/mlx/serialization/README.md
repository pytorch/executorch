...
```bash
python backends/apple/mlx/serialization/generate.py --flatc /path/to/flatc
```
...
3. **Register the op handler** in `ops.py`:
   ...
   ```python
   from executorch.backends.apple.mlx.serialization.mlx_graph_schema import MyNewNode
...
```bash
conda run -n et-mlx python backends/apple/mlx/serialization/generate.py
```
...
```bash
rm -rf backends/apple/mlx/serialization/_generated
rm backends/apple/mlx/serialization/mlx_graph_schema.py
rm backends/apple/mlx/serialization/_generated_serializers.py
python backends/apple/mlx/serialization/generate.py
```
