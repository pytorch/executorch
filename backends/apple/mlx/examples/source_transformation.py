...
from executorch.backends.apple.mlx.examples.cache import ETKVCache, HFStaticCache
...
def transform_attention_mha_to_mlx(
    ...
    """
    from executorch.backends.apple.mlx.examples.et_attention import MLXAttentionMHA
