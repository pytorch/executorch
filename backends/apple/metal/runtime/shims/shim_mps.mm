...
AOTITorchError aoti_torch_mps_set_arg_tensor(
    ...
    @autoreleasepool {
        try {
            ...
            // The kernel was generated by inductor and indexes a strided view as it
            // is laid out in its parent.
            function->setArg(
                idx, *et_tensor, ETMetalKernelFunction::ArgAccess::kStridedInPlace);
