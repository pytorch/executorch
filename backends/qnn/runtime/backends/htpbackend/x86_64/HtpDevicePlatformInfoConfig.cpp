...
HtpDevicePlatformInfoConfig::CreateDevicePlatformInfo(
  ...
  p_device_info_extension->onChipDevice.signedPdSupport =
      htp_options_.pd_session == kHtpSignedPd;
  p_device_info_extension->onChipDevice.socModel =
      static_cast<uint32_t>(qcom_target_soc_info.m_socModel);
  p_device_info_extension->onChipDevice.arch = qcom_target_soc_info.m_htpArch;
