...
class InsertIOQDQ(ExportPass):
    q_dq_map = {
        #per tensor
        torch.ops.quantized_decomposed.quantize_per_tensor.default: torch.ops.quantized_decomposed.dequantize_per_tensor.default,
        ...
        #per channel
        torch.ops.quantized_decomposed.quantize_per_channel.default: torch.ops.quantized_decomposed.dequantize_per_channel.default,
