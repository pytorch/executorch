...
from executorch.backends.qnn.passes import (
    qnn_partitioner_passes,
)

import executorch.backends.qnn.python.PyQnnManagerAdaptor as PyQnnManager
...
def qnn_executorch_config(passes=None) -> exir.ExecutorchBackendConfig:
...
def generate_qnn_executorch_compiler_spec(
    is_fp16: bool, soc_model: str, debug: bool, saver: bool = False
) -> List[CompileSpec]:
    supported_soc_models = {
        "SM8450": PyQnnManager.QcomModel.SM8450,
