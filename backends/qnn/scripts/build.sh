...
usage() {
  ...
  echo "e.g.: executorch$ ./backends/qnn/scripts/build.sh --skip_x86_64"
  exit 1
}
...
if [ "$BUILD_X86_64" = true ]; then
    ...
    rm -f $PRJ_ROOT/backends/qnn/python/*
    cp -fv $BUILD_ROOT/backends/qnn/Py* "$PRJ_ROOT/backends/qnn/python"
fi
