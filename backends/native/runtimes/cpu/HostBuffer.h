 ...
 *
 * Mode is orthogonal to MemoryKind: Mode tracks how the storage was
 * acquired (and how to release it); MemoryKind is the addressing
 * contract the router stamped on the AllocRequest.
 */
class HostBuffer : public Buffer {
 ...
 private:
  HostBuffer(Mode m, void* ptr, size_t bytes, MemoryKind kind)
      : Buffer(bytes, kind),
        mode_(m),
        ptr_(ptr),
