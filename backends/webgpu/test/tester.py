...
# Edge ops the WebGPU runtime implements (see WEBGPU_REGISTER_OP in
# runtime/ops/*); restricts the Vulkan partitioner so it won't delegate ops
# WebGPU lacks (which 0x30 at runtime). Torch ops only; fused ops bypass.
