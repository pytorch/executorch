...
// @generated from q8ta_conv2d.wgsl - DO NOT EDIT.
// wgsl-sha256: f93c4400b1e84039aa29ddbc6470cc0bea2a3e73370ce64700a2d63a42a462e7
inline constexpr const char* kQ8taConv2dWGSL = R"(
...
fn main(
  ...
  // acc is i32: each tap |(x - zp) * w| <= 255 * 128 = 32640, so the sum
  // stays exact while Kh*Kw*IC <= 65793 (2^31 / 32640) and can overflow
  // beyond that.
  var acc: array<i32, 4>;
  for (var j: u32 = 0u; j < 4u; j = j + 1u) {
    acc[j] = 0;
  }
  // General conv: full IC reduction; weight [OC,Kh*Kw*IC].
...
inline constexpr uint32_t kQ8taConv2dWorkgroupSizeX = 64;
inline constexpr uint32_t kQ8taConv2dWorkgroupSizeY = 1;
inline constexpr uint32_t kQ8taConv2dWorkgroupSizeZ = 1;
