...
// @generated from quantize_dequantize_per_row.wgsl - DO NOT EDIT.
// wgsl-sha256: 5ad80c6834f48ea9afd45982b7294fbc9049feda520bebdfaf11932e5464d34a
inline constexpr const char* kQuantizeDequantizePerRowWGSL = R"(
// Copyright (c) Meta Platforms, Inc. and affiliates.
// All rights reserved.
//
// This source code is licensed under the BSD-style license found in the
...
inline constexpr uint32_t kQuantizeDequantizePerRowWorkgroupSizeX = 64;
inline constexpr uint32_t kQuantizeDequantizePerRowWorkgroupSizeY = 1;
inline constexpr uint32_t kQuantizeDequantizePerRowWorkgroupSizeZ = 1;
