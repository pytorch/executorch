...
inline constexpr uint32_t kChooseQparamsAffineWorkgroupSizeX = 256;
inline constexpr uint32_t kChooseQparamsAffineWorkgroupSizeY = 1;
inline constexpr uint32_t kChooseQparamsAffineWorkgroupSizeZ = 1;
