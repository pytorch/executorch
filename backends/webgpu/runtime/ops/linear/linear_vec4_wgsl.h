...
inline constexpr uint32_t kLinearVec4WorkgroupSizeX = 8;
inline constexpr uint32_t kLinearVec4WorkgroupSizeY = 8;
inline constexpr uint32_t kLinearVec4WorkgroupSizeZ = 1;
