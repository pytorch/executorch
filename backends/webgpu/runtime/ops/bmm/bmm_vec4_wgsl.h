...
// @generated from bmm_vec4.wgsl - DO NOT EDIT.
// wgsl-sha256: 32bd94bcb0c0758b60267224f737bac142aec0e6789f7f2d6433cd4250cfa7b5
inline constexpr const char* kBmmVec4WGSL = R"(
struct Params {
  B: u32,
  M: u32,
  N: u32,
...
inline constexpr uint32_t kBmmVec4WorkgroupSizeX = 8;
inline constexpr uint32_t kBmmVec4WorkgroupSizeY = 8;
inline constexpr uint32_t kBmmVec4WorkgroupSizeZ = 1;
