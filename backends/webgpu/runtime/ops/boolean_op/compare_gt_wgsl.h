...
inline constexpr uint32_t kCompareGtWorkgroupSizeX = 64;
inline constexpr uint32_t kCompareGtWorkgroupSizeY = 1;
inline constexpr uint32_t kCompareGtWorkgroupSizeZ = 1;
