...
inline constexpr uint32_t kCompareGeWorkgroupSizeX = 64;
inline constexpr uint32_t kCompareGeWorkgroupSizeY = 1;
inline constexpr uint32_t kCompareGeWorkgroupSizeZ = 1;
