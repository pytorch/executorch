...
// @generated from sdpa_fd_split_f16.wgsl - DO NOT EDIT.
// wgsl-sha256: 3396d4f0d990d59ded70734cb92feb6c776635695b5d5c21b8cdfb7e55c8ed6d
inline constexpr const char* kSdpaFdSplitF16WGSL = R"(
enable f16;

// f16 K/V-cache variant of sdpa_fd_split.wgsl (f32 compute + softmax stats).
...
inline constexpr uint32_t kSdpaFdSplitF16WorkgroupSizeX = 64;
inline constexpr uint32_t kSdpaFdSplitF16WorkgroupSizeY = 1;
inline constexpr uint32_t kSdpaFdSplitF16WorkgroupSizeZ = 1;
