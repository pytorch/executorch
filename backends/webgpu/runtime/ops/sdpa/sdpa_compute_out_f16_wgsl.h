...
// @generated from sdpa_compute_out_f16.wgsl - DO NOT EDIT.
// wgsl-sha256: 64fa4352362fd055d8dde0d4fe5cde022ea1e655187fce1e1a6a0731a6c2372f
inline constexpr const char* kSdpaComputeOutF16WGSL = R"(
enable f16;

// f16 V-cache variant of sdpa_compute_out.wgsl (f32 compute).
...
inline constexpr uint32_t kSdpaComputeOutF16WorkgroupSizeX = 64;
inline constexpr uint32_t kSdpaComputeOutF16WorkgroupSizeY = 1;
inline constexpr uint32_t kSdpaComputeOutF16WorkgroupSizeZ = 1;
