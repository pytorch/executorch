 ...
 */
#ifndef EXECUTORCH_QNN_EXECUTORCH_BACKENDS_QNN_BACKEND_COMMON_H_
#define EXECUTORCH_QNN_EXECUTORCH_BACKENDS_QNN_BACKEND_COMMON_H_
...
#endif  // EXECUTORCH_QNN_EXECUTORCH_BACKENDS_QNN_BACKEND_COMMON_H_
