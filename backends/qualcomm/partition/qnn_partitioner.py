...
from .common_defs import allow_list_operator, not_supported_operator, to_be_implemented_operator
...
class QnnOperatorSupport(OperatorSupportBase):
    ...
    def is_node_supported(self, _, node: torch.fx.Node) -> bool:
        ...
        if node.target in to_be_implemented_operator:
            print(f"[QNN Partitioner Op Support]: {node.target.__name__} | Skipped, this op can be supported, please report an issue in https://github.com/pytorch/executorch/issues")
            return False
