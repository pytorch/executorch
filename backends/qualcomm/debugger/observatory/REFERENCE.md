...
### 1.3 Frontend Stage Signatures and Input Sources
...
### 1.4 View Block Contracts (Frontend Output)
...
### 1.5 Information Object Map Across Boundaries
...
### 1.7 Graph Pipeline (Observatory -> Viewer)
...
### 1.8 fx_viewer Type Bridge (Python Side)
...
### 1.9 fx_viewer Runtime API Used by Observatory (JS Side)
...
### 1.10 Graph Layer Naming and Selection Rules
...
### 1.11 Python-to-JS Dataflow Cheat Sheet
...
## 2. Embedded References (Single Source)
...
## 3. Performance Notes — Viewer Lifecycle and Caching

### 3.1 Single-record viewers: live DOM cache with LRU eviction
...
### 3.2 Compare-mode viewers: state-snapshot cache
