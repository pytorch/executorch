...
# function call:
#
#     include(${CMAKE_CURRENT_SOURCE_DIR}/../portable/runtime/metal_v2/MlxJit.cmake)
...
# Resolve paths relative to THIS file (backends/portable/runtime/metal_v2/).
set(_mlx_jit_module_dir
    ${CMAKE_CURRENT_LIST_DIR}/ops/mlx_jit
    CACHE INTERNAL "ops/mlx_jit/ source directory"
)
# Submodule lives at backends/mlx/third-party/mlx/ — three levels up from
# this file then back down.
