...
define_load_int8x4_buffer_8d_fns(t_inp)
// Generate 8D storing functions for t_outp
$if OUTPUT_STORAGE == "buffer":
  define_store_buffer_8d_fns(t_outp, T)
$else:
  define_store_texture_8d_fns(t_outp, VEC4_T)
