...
${layout_declare_tensor(B, "r", "t_mat2", DTYPE, STORAGE, is_scalar_array=False)}
$if HAS_BIAS:
...
void main() {
  ...
  for (int k4 = 0; k4 < K4; k4++) {
    ...
    load_mat2_tile_with_checks(w_tile, n4_start, mul_4(k4), b, N4, K);
    fp_accumulate_with_fp_weight(out_tile, in_tile, w_tile);
  }

#ifdef HAS_BIAS
  apply_bias_vec(out_tile, n4_start, m_start, N4, N);
#endif
