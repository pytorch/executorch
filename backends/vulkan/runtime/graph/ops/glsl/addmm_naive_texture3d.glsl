...
vec4 get_bias_texel_W_packed(ivec3 logical_pos) {
  ...
  if (bias_sizes.y == 1) {
    bias_pos[bias_axis_mapping.y] = 0;
  } else {
    bias_pos[bias_axis_mapping.y] = logical_pos.y;
  }
  if (bias_sizes.x == 1) {
    bias_pos[bias_axis_mapping.x] = 0;
    ...
    bias_pos[bias_axis_mapping.x] = logical_pos.x;
  }
...
vec4 matmul_naive_k_dim_packed(const ivec3 out_mpos) {
  ivec3 mat1_pos;
  mat1_pos[mat1_axis_mapping.x] = 0;
  mat1_pos[mat1_axis_mapping.y] = out_mpos.y;
  mat1_pos[mat1_axis_mapping.z] = out_mpos.z;
  ...
  for (int i = 0; i < K; ++i) {
    ...
    for (int r = 0; r < 4; ++r) {
      ...
      mat2_pos[mat2_axis_mapping.z] = out_mpos.z;
#endif // MAT2_IS_TRANSPOSED
...
vec4 matmul_naive_k_dim_packed_row_dim_packed(
  ...
  ivec3 mat2_pos;
  mat2_pos[mat2_axis_mapping.x] = out_mpos.x;
  mat2_pos[mat2_axis_mapping.y] = 0;
  mat2_pos[mat2_axis_mapping.z] = out_mpos.z;

  ivec3 mat2_pos_offset = ivec3(0);
  mat2_pos_offset[mat2_axis_mapping.y] = 1;

  const int mat2_y_axis = mat2_axis_mapping.y;
  ...
  for (int i = 0;
       i < K;
       ++i, mat1_pos[mat1_axis_mapping.x]++, mat2_pos[mat2_axis_mapping.y]+=4) {
    ...
    for (int r = 0; r < 4; ++r) {
      ...
      ivec3 mat2_pos = ivec3(0);
      mat2_pos[mat2_axis_mapping.x] = out_mpos.x;
      mat2_pos[mat2_axis_mapping.y] = 4 * i + r;
      mat2_pos[mat2_axis_mapping.z] = out_mpos.z;
...
void main() {
  ...
  ivec3 out_pos = to_texture_pos(out_mpos, out_axis_mapping);
