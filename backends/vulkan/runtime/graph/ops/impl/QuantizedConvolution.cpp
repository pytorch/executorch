  ...
  uint32_t apply_bias = 1)
{
  ...
  std::vector<int64_t> out_sizes = graph.sizes_of(output);
  int32_t output_sizes_x = utils::val_at(-1, out_sizes);
  int32_t output_sizes_y = utils::val_at(-2, out_sizes);
  int32_t output_sizes_z = utils::val_at(-3, out_sizes);
  int32_t output_sizes_w = utils::val_at(-4, out_sizes);

  std::vector<int64_t> in_sizes = graph.sizes_of(input);
  int32_t input_sizes_x = utils::val_at(-1, in_sizes);
  int32_t input_sizes_y = utils::val_at(-2, in_sizes);
  int32_t input_sizes_z = utils::val_at(-3, in_sizes);
  int32_t input_sizes_w = utils::val_at(-4, in_sizes);
  ...
  std::cout << "output sizes: "
            ...
            << output_sizes_z << ", "
            << output_sizes_y << ", "
            << output_sizes_x << std::endl;
  std::cout << "input sizes: "
            << input_sizes_w << ", "
            << input_sizes_z << ", "
            << input_sizes_y << ", "
            << input_sizes_x << std::endl;
#endif

  vkapi::SpecVarList spec_constants = {
      apply_bias,
      conv2d_params_stride_x, conv2d_params_stride_y,
      conv2d_params_padding_x, conv2d_params_padding_y,
      ...
      output_sizes_x, output_sizes_y, output_sizes_z, output_sizes_w,
      input_sizes_x, input_sizes_y, input_sizes_z, input_sizes_w
  };
...
void add_input_im2col_node(
  ...
  vkapi::SpecVarList spec_constants = GenerateSpecConstants(graph, conv_params, groups, output_image, input_image);
...
void add_input_im2col_packed_int8_node(
  ...
  vkapi::SpecVarList spec_constants = GenerateSpecConstants(graph, conv_params, groups, output, input);
...
void add_conv2d_q8csw_linear_node(
  ...
  vkapi::SpecVarList spec_constants = GenerateSpecConstants(graph, conv_params, groups, output_image, input_image, apply_bias);
...
void add_conv2d_q8ta_q8csw_q8to_node(
  ...
  vkapi::SpecVarList spec_constants = GenerateSpecConstants(graph, conv_params, groups, packed_int8_output, packed_int8_input, apply_bias);
