...
constexpr Dim4DType kDim4DWidth = Dim4DType::DIM4D_WIDTH;
constexpr Dim4DType kDim4DHeight = Dim4DType::DIM4D_HEIGHT;
constexpr Dim4DType kDim4DChannel = Dim4DType::DIM4D_CHANNEL;
constexpr Dim4DType kDim4DBatch = Dim4DType::DIM4D_BATCH;
