...
class TestSerialization(unittest.TestCase):
    ...
    def test_serialize_xnnpack_binary(self):
        ...
        self.assertEqual(serialized_binary[VulkanDelegateHeader.MAGIC_IX], b"VKDG")
        ...
        constants_offset = int.from_bytes(
            serialized_binary[VulkanDelegateHeader.CONSTANTS_OFFSET_IX],
            byteorder="little",
        )
        constants_size = int.from_bytes(
            serialized_binary[VulkanDelegateHeader.CONSTANTS_SIZE_IX],
            byteorder="little",
        )
