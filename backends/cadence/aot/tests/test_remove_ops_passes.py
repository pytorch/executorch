...
class TestRemoveOpsPasses(unittest.TestCase):
    ...
    def test_remove_nop_select_before_view(self) -> None:
        ...
        sample_input = [torch.randn(1, 5, 6, dtype=torch.float32)]
        validate(gm_before, graph_after_passes, sample_input, "RemoveNopSelectOpPass")
    ...
    def test_remove_nop_select_before_add(self) -> None:
        ...
        # Verify numerical correctness
        sample_inputs = [
            torch.randn(1, 5, 6, dtype=torch.float32),
            torch.randn(1, 5, 6, dtype=torch.float32),
        ]
        validate(gm_before, graph_after_passes, sample_inputs, "RemoveNopSelectOpPass")
