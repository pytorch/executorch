...
class TestFuseMMWithAddPass(TestFusionPassesBase):
    ...
    def test_fuse_mm_with_add(self) -> None:
        ...
        validate(gm_before, converted_graph, (x_input, y_input, z_input), "FuseMMWithAdd")
...
class TestFusionPasses(TestFusionPassesBase):
    ...
    def test_view_fusion(self) -> None:
        ...
        # Validate numerical accuracy
        inputs = [x_input]
        validate(gm_before, converted_graph, inputs, "FuseCascadedViewOps")
    ...
    def test_replace_dequant_quant_with_requantize(self) -> None:
        ...
        # Validate numerical accuracy
        validate(gm_before, converted_graph, (x_input,), "FuseQuantDequantToRequantizePass")
    ...
    def test_fuse_then_transpose_pass(self) -> None:
        ...
        # Validate numerical accuracy
        validate(gm_before, gm_after_pass, [], "FuseFullThenReshapePass")
