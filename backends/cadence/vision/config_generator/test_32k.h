...
#define NUM_CONV_LAYERS 23

 #define IDMA_BUFFER_SIZE_DRAM0 (31250) // 30 KB for DRAM0
 #define IDMA_BUFFER_SIZE_DRAM1 (31250) // 30 KB for DRAM1
...
static const conv_layer_config_t CONV_LAYER_CONFIGS[] = {
    {
        ...
        // Input tile: 64×19 (edges: 3,3,3,3)
        .in_dim1_size = 64,
        .in_dim1_pitch = 70,
        .in_dim2_size = 19,
        .in_dim2_pitch = 1330,
        ...
        // Tiling: 64 ch/tile × 1 tiles, 7 rows/tile × 5 tiles
        .n_tile_size = 64,
        .n_tiles = 1,
        .n_tile_size_last = 64,
        .height_tiles = 5,
    ...
    },
    {
        ...
        // Tiling: 256 ch/tile × 1 tiles, 3 rows/tile × 6 tiles
        .n_tile_size = 256,
        .n_tiles = 1,
    ...
    },
    {
        ...
        // Input tile: 16×13 (edges: 0,0,0,0)
        .in_dim1_size = 16,
        .in_dim1_pitch = 16,
        .in_dim2_size = 13,
        .in_dim2_pitch = 208,
        ...
        // Buffer sizes (bytes)
        .input_buffer_size = 13312,
        .coeff_buffer_size = 4096,
        .output_buffer_size = 13312,
        .bias_buffer_size = 256,
        .outscale_buffer_size = 128,
        ...
        // Tiling: 64 ch/tile × 1 tiles, 13 rows/tile × 2 tiles
        .n_tile_size = 64,
        .n_tiles = 1,
        .n_tile_size_last = 64,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 64 ch/tile × 1 tiles, 3 rows/tile × 6 tiles
        .n_tile_size = 64,
        .n_tiles = 1,
        .n_tile_size_last = 64,
        .height_tiles = 6,
