...
Tensor& cat_out(KernelRuntimeContext& ctx,
                ...
                Tensor& out)
{
    ...
    ET_KERNEL_CHECK(ctx, torch::executor::check_cat_args(tensors, dim, out), InvalidArgument, out);

    int kTensorDimensionLimit = executorch::runtime::kTensorDimensionLimit;
    Tensor::SizesType expected_out_size[kTensorDimensionLimit];
    size_t expected_out_dim = 0;
     torch::executor::get_cat_out_target_size(tensors, dim, expected_out_size, &expected_out_dim);
