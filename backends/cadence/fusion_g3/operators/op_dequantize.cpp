 ...
 */
void check_dequantize_per_tensor_args(const Tensor& input,
                                    int64_t quant_min,
                                    int64_t quant_max,
                                    ScalarType dtype,
...
Tensor& dequantize_per_tensor_tensor_args_out(const Tensor& input,
                                            const Tensor& scale,
...
Tensor& dequantize_per_channel_out(const Tensor& input,
                                const Tensor& scale,
