...
Tensor& sub_out(
  ...
  if (((a.scalar_type() == ScalarType::Int) && (b.scalar_type() == ScalarType::Int) && (out.scalar_type() == ScalarType::Int))&& (optimized)) {
  ...
  } else if (((a.scalar_type() == ScalarType::Float) && (b.scalar_type() == ScalarType::Float) && (out.scalar_type() == ScalarType::Float))&& (optimized)) {
  ...
  else if(((a.scalar_type() == ScalarType::Int) && (b.scalar_type() == ScalarType::Float) && (out.scalar_type() == ScalarType::Float))&& (optimized))
  {
    const int* const inp1_data = a.const_data_ptr<int>();
		const float* const inp2_data = b.const_data_ptr<float>();
		float* const out_data = out.mutable_data_ptr<float>();
	...
	else if(((a.scalar_type() == ScalarType::Float) && (b.scalar_type() == ScalarType::Int) && (out.scalar_type() == ScalarType::Float))&& (optimized))
	{
		const float* const inp1_data = a.const_data_ptr<float>();
		const int* const inp2_data = b.const_data_ptr<int>();
		float* const out_data = out.mutable_data_ptr<float>();
...
Tensor& sub_scalar_out(
  ...
  if ((a.scalar_type() == ScalarType::Int) && (b.isIntegral(false)) && (out.scalar_type() == ScalarType::Int)) {
    const int* const inp1_data = a.const_data_ptr<int>();
    int inp2_val;
    ...
    XT_KERNEL_CHECK(
        ...
        alpha_val,
        out.numel());
  } else if ((a.scalar_type() == ScalarType::Float) && (b.isFloatingPoint()) && (out.scalar_type() == ScalarType::Float)) {
    const float* const inp1_data = a.const_data_ptr<float>();
    float inp2_val;
    torch::executor::native::utils::extract_scalar(b, &inp2_val);
  ...
  else if ((a.scalar_type() == ScalarType::Int) && (b.isFloatingPoint()) && (out.scalar_type() == ScalarType::Float))
  {
    const int* const inp1_data = a.const_data_ptr<int>();
    float inp2_val;
    torch::executor::native::utils::extract_scalar(b, &inp2_val);
  ...
  else if ((a.scalar_type() == ScalarType::Float) && (b.isIntegral(false)) && (out.scalar_type() == ScalarType::Float))
  {
    const float* const inp1_data = a.const_data_ptr<float>();
    int inp2_val;
    torch::executor::native::utils::extract_scalar(b, &inp2_val);
