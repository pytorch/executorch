...
// This implements a specialized int8 x int8 -> int8 quantized 2d conv kernel
// for NHWC layout. This variant is optimized for asymmetric int8 inputs,
...
__attribute__((noinline)) void conv2d_nhwc_asym8sxsym8s_asym8s_core(
    // All the arrays
...
void quantized_conv_nhwc_asym8sxsym8s_asym8s_per_tensor_out(
  ...
  if (optimized) {
    ...
    // Use specialized int8 kernel
    conv2d_nhwc_asym8sxsym8s_asym8s_core(
