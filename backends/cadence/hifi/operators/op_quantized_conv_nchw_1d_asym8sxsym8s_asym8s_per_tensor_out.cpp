...
void xa_opt_quantized_conv_nchw_1d_asym8sxsym8s_asym8s(
...
void quantized_conv_nchw_1d_asym8sxsym8s_asym8s_per_tensor_out(
    KernelRuntimeContext& ctx,
    const Tensor& input,
    const Tensor& weight,
    const Tensor& bias,
    ...
    Tensor& out) {
  xa_opt_quantized_conv_nchw_1d_asym8sxsym8s_asym8s(
      ctx,
      input,
      weight,
      bias,
