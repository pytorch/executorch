...
// Specialized 1D depthwise NCHW convolution for int8 x int8 -> int8
void xa_opt_quantized_conv_nchw_1d_depthwise_asym8sxsym8s_asym8s(
...
void quantized_conv_nchw_1d_depthwise_asym8sxsym8s_asym8s_per_tensor_out(
    ...
    Tensor& out) {
  xa_opt_quantized_conv_nchw_1d_depthwise_asym8sxsym8s_asym8s(
      ctx,
      input,
      weight,
      bias,
