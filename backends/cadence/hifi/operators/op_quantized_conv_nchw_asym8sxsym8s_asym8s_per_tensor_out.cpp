...
// for NCHW layout. This variant is optimized for asymmetric int8 inputs,
...
__attribute__((noinline)) void conv2d_nchw_asym8sxsym8s_asym8s_core(
    // All the arrays
...
void quantized_conv_nchw_asym8sxsym8s_asym8s_per_tensor_out(
  ...
  if (optimized) {
    ...
    conv2d_nchw_asym8sxsym8s_asym8s_core(
