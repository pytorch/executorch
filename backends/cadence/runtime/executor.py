...
def execute(args: List[str]) -> Tuple[str, str]:
    ...
    # TODO(poweic): revert PYTHONPATH to whatever it was, but be careful about
    # try and except below
    if "PYTHONPATH" in os.environ:
        del os.environ["PYTHONPATH"]

    try:
        return _execute_subprocess(args)  # TODO: cwd=build_utils.get_hg_root()
...
class Executor:
    ...
    def __init__(
        self,
        working_dir: str = ".",  # TODO: use temp dir
    ):
