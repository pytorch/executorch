 ...
 */
inline STANDALONE_HOST_DEVICE uint8_t fp8e5m2fnuz_from_fp32_value(float f) {
  /*
...
struct alignas(1) Float8_e5m2fnuz {
  ...
  constexpr STANDALONE_HOST_DEVICE Float8_e5m2fnuz(uint8_t bits, from_bits_t)
      : x(bits) {}
  inline STANDALONE_HOST_DEVICE Float8_e5m2fnuz(float value);
...
#include <executorch/backends/cuda/runtime/c10/util/Float8_e5m2fnuz-inl.h> // IWYU pragma: keep
