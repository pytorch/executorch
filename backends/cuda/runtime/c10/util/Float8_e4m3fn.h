 ...
 */
inline STANDALONE_HOST_DEVICE float fp8e4m3fn_to_fp32_value(uint8_t input) {
  /*
 ...
 */
inline STANDALONE_HOST_DEVICE uint8_t fp8e4m3fn_from_fp32_value(float f) {
  /*
...
struct alignas(1) Float8_e4m3fn {
  ...
  constexpr STANDALONE_HOST_DEVICE Float8_e4m3fn(uint8_t bits, from_bits_t)
      : x(bits) {}
  inline STANDALONE_HOST_DEVICE Float8_e4m3fn(float value);
...
#include <executorch/backends/cuda/runtime/c10/util/Float8_e4m3fn-inl.h> // IWYU pragma: keep
