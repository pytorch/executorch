...
/// and inspired by Half implementation from pytorch/executorch/backends/cuda/runtime/c10/util/Half.h
 ...
 */
inline STANDALONE_HOST_DEVICE float fp8e5m2_to_fp32_value(uint8_t input) {
  /*
 ...
 */
inline STANDALONE_HOST_DEVICE uint8_t fp8e5m2_from_fp32_value(float f) {
  /*
...
struct alignas(1) Float8_e5m2 {
  ...
  constexpr STANDALONE_HOST_DEVICE Float8_e5m2(uint8_t bits, from_bits_t)
      : x(bits) {}
  inline STANDALONE_HOST_DEVICE Float8_e5m2(float value);
  inline STANDALONE_HOST_DEVICE operator float() const;
  inline STANDALONE_HOST_DEVICE bool isnan() const;
  inline STANDALONE_HOST_DEVICE bool isinf() const;
};
...
#include <executorch/backends/cuda/runtime/c10/util/Float8_e5m2-inl.h> // IWYU pragma: keep
