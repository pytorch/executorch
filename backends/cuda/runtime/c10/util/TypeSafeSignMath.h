...
#if STANDALONE_CLANG_HAS_WARNING("-Wstring-conversion")
STANDALONE_CLANG_DIAGNOSTIC_IGNORE("-Wstring-conversion")
#endif
...
///       However, notably, executorch::backends::cuda::c10::Half does not :-(
