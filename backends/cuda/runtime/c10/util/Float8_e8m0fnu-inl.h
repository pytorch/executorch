...
#include <executorch/backends/cuda/runtime/c10/util/floating_point_utils.h>
...
inline STANDALONE_HOST_DEVICE Float8_e8m0fnu::operator float() const {
  ...
  if (x == 0) {
    return executorch::backends::cuda::c10::detail::fp32_from_bits(0x00400000);
  }

  // if exponent is NaN, need to special case to return properly encoded NaN
  if (isnan()) {
    return executorch::backends::cuda::c10::detail::fp32_from_bits(0x7f800001);
  }

  // leave sign at 0, set the exponent bits, leave stored mantissa at 0
  uint32_t res = x << 23;

  return executorch::backends::cuda::c10::detail::fp32_from_bits(res);
}
...
/// conversion from executorch::backends::cuda::c10::Float8_e8m0fnu to float.

} // namespace executorch::backends::cuda::c10

namespace std {

template <> class numeric_limits<executorch::backends::cuda::c10::Float8_e8m0fnu> {
public:
  ...
  static constexpr executorch::backends::cuda::c10::Float8_e8m0fnu min() {
    // 2^-127
    return executorch::backends::cuda::c10::Float8_e8m0fnu(
        0b00000000, executorch::backends::cuda::c10::Float8_e8m0fnu::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::Float8_e8m0fnu lowest() {
    // 2^-127
    return executorch::backends::cuda::c10::Float8_e8m0fnu(
        0b00000000, executorch::backends::cuda::c10::Float8_e8m0fnu::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::Float8_e8m0fnu max() {
    // 254 biased, which is 127 unbiased, so 2^127
    return executorch::backends::cuda::c10::Float8_e8m0fnu(
        0b11111110, executorch::backends::cuda::c10::Float8_e8m0fnu::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::Float8_e8m0fnu epsilon() {
    ...
    return executorch::backends::cuda::c10::Float8_e8m0fnu(
        0b01111111, executorch::backends::cuda::c10::Float8_e8m0fnu::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::Float8_e8m0fnu round_error() {
    // 0.5 in float, which is 2^-1, and -1 + 127 = 126
    return executorch::backends::cuda::c10::Float8_e8m0fnu(
        0b01111110, executorch::backends::cuda::c10::Float8_e8m0fnu::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::Float8_e8m0fnu quiet_NaN() {
    return executorch::backends::cuda::c10::Float8_e8m0fnu(
        0b11111111, executorch::backends::cuda::c10::Float8_e8m0fnu::from_bits());
  }
};
