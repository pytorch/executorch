...
inline STANDALONE_HOST_DEVICE uint8_t fp8e8m0fnu_from_fp32_value(float f) {
  ...
  uint32_t f_bits = executorch::backends::cuda::c10::detail::fp32_to_bits(f);
...
struct alignas(1) Float8_e8m0fnu {
  ...
  constexpr STANDALONE_HOST_DEVICE Float8_e8m0fnu(uint8_t bits, from_bits_t)
      : x(bits) {}
  inline STANDALONE_HOST_DEVICE Float8_e8m0fnu(float value);
...
#include <executorch/backends/cuda/runtime/c10/util/Float8_e8m0fnu-inl.h> // IWYU pragma: keep
