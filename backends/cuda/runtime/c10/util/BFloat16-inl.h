...
inline STANDALONE_HOST_DEVICE BFloat16::BFloat16(float value)
    ...
    defined(SYCL_EXT_ONEAPI_BFLOAT16_MATH_FUNCTIONS)
      x(executorch::backends::cuda::c10::bit_cast<uint16_t>(sycl::ext::oneapi::bfloat16(value)))
#else
      // RNE by default
...
inline STANDALONE_HOST_DEVICE
    BFloat16::operator sycl::ext::oneapi::bfloat16() const {
...
inline STANDALONE_HOST_DEVICE BFloat16 &operator+=(BFloat16 &a,
                                                   const BFloat16 &b) {
  a = a + b;
  return a;
}
...
template <> class numeric_limits<executorch::backends::cuda::c10::BFloat16> {
public:
  ...
  static constexpr executorch::backends::cuda::c10::BFloat16 min() {
    return executorch::backends::cuda::c10::BFloat16(0x0080,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::BFloat16 lowest() {
    return executorch::backends::cuda::c10::BFloat16(0xFF7F,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::BFloat16 max() {
    return executorch::backends::cuda::c10::BFloat16(0x7F7F,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::BFloat16 epsilon() {
    return executorch::backends::cuda::c10::BFloat16(0x3C00,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::BFloat16 round_error() {
    return executorch::backends::cuda::c10::BFloat16(0x3F00,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::BFloat16 infinity() {
    return executorch::backends::cuda::c10::BFloat16(0x7F80,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::BFloat16 quiet_NaN() {
    return executorch::backends::cuda::c10::BFloat16(0x7FC0,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::BFloat16 signaling_NaN() {
    return executorch::backends::cuda::c10::BFloat16(0x7F80,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
  static constexpr executorch::backends::cuda::c10::BFloat16 denorm_min() {
    return executorch::backends::cuda::c10::BFloat16(0x0001,
                                     executorch::backends::cuda::c10::BFloat16::from_bits());
  }
};
