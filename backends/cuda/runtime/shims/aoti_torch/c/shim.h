...
#include <executorch/backends/cuda/runtime/c10/core/Layout.h>
#include <executorch/backends/cuda/runtime/slim/core/Empty.h>
#include <executorch/backends/cuda/runtime/slim/core/FromBlob.h>
#include <executorch/backends/cuda/runtime/slim/core/FromScalar.h>
...
#ifdef USE_CUDA
#include <executorch/backends/cuda/runtime/shims/aoti_torch/c/shim_cuda.h>
#endif
...
#define AOTI_TORCH_SCALAR_TO_TENSOR_IMPL(dtype, ctype)                         \
  AOTI_TORCH_EXPORT AOTITorchError aoti_torch_scalar_to_tensor_##dtype(        \
    ...
    *ret_new_tensor = new executorch::backends::cuda::slim::SlimTensor(                        \
        executorch::backends::cuda::slim::scalar_to_tensor(value));                            \
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_new_tensor_handle(
  ...
  *new_handle = new executorch::backends::cuda::slim::SlimTensor(*orig_handle);
  return AOTI_TORCH_SUCCESS;
}
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_clone(AtenTensorHandle self,
  ...
  executorch::backends::cuda::slim::SlimTensor tmp_tensor = executorch::backends::cuda::slim::empty_strided(
      self->sizes(), self->strides(), self->dtype(),
      {self->device_type(), self->device_index()});
  tmp_tensor.copy_(*self);
  *ret = new executorch::backends::cuda::slim::SlimTensor(tmp_tensor);
  return AOTI_TORCH_SUCCESS;
}
...
AOTI_TORCH_EXPORT AOTITorchError aoti_torch_clone_preserve_strides(
  ...
  executorch::backends::cuda::slim::SlimTensor tmp_tensor = *self;
