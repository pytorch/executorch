...
AOTITorchError aoti_torch_cuda_int6_plain_mm(
  ...
  ET_CHECK_OR_RETURN_ERROR(
      self != nullptr,
      InvalidArgument,
      "aoti_torch_cuda_int6_plain_mm: self is null");

  ET_CHECK_OR_RETURN_ERROR(
      ql != nullptr,
      InvalidArgument,
      "aoti_torch_cuda_int6_plain_mm: ql is null");

  ET_CHECK_OR_RETURN_ERROR(
      qh != nullptr,
      InvalidArgument,
      "aoti_torch_cuda_int6_plain_mm: qh is null");

  ET_CHECK_OR_RETURN_ERROR(
      scale != nullptr,
      InvalidArgument,
      "aoti_torch_cuda_int6_plain_mm: scale is null");

  ET_CHECK_OR_RETURN_ERROR(
      steps != nullptr,
      InvalidArgument,
      "aoti_torch_cuda_int6_plain_mm: steps is null");

  ET_CHECK_OR_RETURN_ERROR(
      ret0 != nullptr,
      InvalidArgument,
      "aoti_torch_cuda_int6_plain_mm: ret0 is null");
  ...
  _int6_plain_mm_cuda(*self, *ql, *qh, *scale, *steps, group_size, C);
