 ...
 * failure)
 */
AOTI_CUDA_EXPORT AOTITorchError aoti_torch_empty_strided(
    int64_t ndim,
    const int64_t* sizes_ptr,
    const int64_t* strides_ptr,
    int32_t dtype,
 ...
 * failure)
 */
AOTI_CUDA_EXPORT AOTITorchError aoti_torch_delete_tensor_object(Tensor* tensor);
 ...
 */
AOTI_CUDA_EXPORT AOTITorchError aoti_torch__reinterpret_tensor(
    Tensor* self,
    int64_t ndim,
    const int64_t* sizes_ptr,
    const int64_t* strides_ptr,
...
AOTI_CUDA_EXPORT void clear_all_tensors();
} // extern "C"
