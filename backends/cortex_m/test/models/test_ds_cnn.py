...
ops_before_transforms: dict[str, int] = {
    ...
    "executorch_exir_dialects_edge__ops_quantized_decomposed_dequantize_per_tensor_default": 19,
    "executorch_exir_dialects_edge__ops_quantized_decomposed_quantize_per_tensor_default": 17,
}
