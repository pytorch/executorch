...
ops_before_transforms: dict[str, int] = {
    ...
    "executorch_exir_dialects_edge__ops_aten_constant_pad_nd_default": 2,
    ...
    "executorch_exir_dialects_edge__ops_quantized_decomposed_dequantize_per_tensor_default": 25,
    "executorch_exir_dialects_edge__ops_quantized_decomposed_quantize_per_tensor_default": 20,
}
