...
// See SharedPsoCache.h for the process-wide PSO cache that
// getOrCompilePsoFromSource consults.
//===----------------------------------------------------------------------===//
...
public:
  ...
  // setter after constructing both objects so the kernel compiler can
  // route MTL4 PSO creation through the backend.
...
private:
  ...
  // available or hasn't been wired yet — compile() falls back to the
  // standard MTL3 PSO creation in that case.
