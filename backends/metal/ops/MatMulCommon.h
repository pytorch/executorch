...
// Shared host-side helpers used by every matmul-family op
// (MatMulOp / AddMMOp / BAddBMMOp / BatchedMatMulOp). Marked inline /
...
// substantial speedup (~2-3x on prefill matmul / SDPA shapes).
// Resolution order:
...
// (mlx_jit_helpers::makeMlxFusedFCs uses MLX's slot numbering
// 10/100/110/200/201/202).
