...
inline STANDALONE_HOST_DEVICE Float8_e4m3fnuz operator/(
...
inline STANDALONE_HOST_DEVICE Float8_e4m3fnuz
operator+(Float8_e4m3fnuz a, int b) {
...
inline STANDALONE_HOST_DEVICE Float8_e4m3fnuz
operator+(int a, Float8_e4m3fnuz b) {
...
inline STANDALONE_HOST_DEVICE Float8_e4m3fnuz
operator+(Float8_e4m3fnuz a, int64_t b) {
  return a + static_cast<Float8_e4m3fnuz>(b);
}
inline STANDALONE_HOST_DEVICE Float8_e4m3fnuz
operator-(Float8_e4m3fnuz a, int64_t b) {
...
inline STANDALONE_HOST_DEVICE Float8_e4m3fnuz
operator+(int64_t a, Float8_e4m3fnuz b) {
  return static_cast<Float8_e4m3fnuz>(a) + b;
}
inline STANDALONE_HOST_DEVICE Float8_e4m3fnuz
operator-(int64_t a, Float8_e4m3fnuz b) {
