...
#include <executorch/backends/aoti/slim/c10/util/Float8_fnuz_cvt.h>
#include <cstring>
#include <limits>
...
inline STANDALONE_HOST_DEVICE Float8_e5m2fnuz operator/(
...
inline STANDALONE_HOST_DEVICE Float8_e5m2fnuz
operator+(Float8_e5m2fnuz a, int b) {
...
inline STANDALONE_HOST_DEVICE Float8_e5m2fnuz
operator+(int a, Float8_e5m2fnuz b) {
...
inline STANDALONE_HOST_DEVICE Float8_e5m2fnuz
operator+(Float8_e5m2fnuz a, int64_t b) {
  return a + static_cast<Float8_e5m2fnuz>(b);
}
inline STANDALONE_HOST_DEVICE Float8_e5m2fnuz
operator-(Float8_e5m2fnuz a, int64_t b) {
...
inline STANDALONE_HOST_DEVICE Float8_e5m2fnuz
operator+(int64_t a, Float8_e5m2fnuz b) {
  return static_cast<Float8_e5m2fnuz>(a) + b;
}
inline STANDALONE_HOST_DEVICE Float8_e5m2fnuz
operator-(int64_t a, Float8_e5m2fnuz b) {
