...
class DecomposeMaxPool1dPass(ArmOpTargetedPass):
    ...
    target_ops = (torch.ops.aten.max_pool1d.default,)
    ...
    def call_operator(self, op, args, kwargs, meta):
        ...
        # (N, C, L) → (N, C, 1, L)
        unsqueeze_meta = meta_without_qparams(meta)
        ...
        # (N, C, 1, L') → (N, C, L')
        squeeze_meta = meta_without_qparams(meta)
