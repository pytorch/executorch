...
SCENARIO_FILES = (
    Path("backends/arm/test/public_api_bc/ethosu_flow.py"),
    Path("backends/arm/test/public_api_bc/vgf_fp_flow.py"),
    Path("backends/arm/test/public_api_bc/vgf_int_flow.py"),
)
