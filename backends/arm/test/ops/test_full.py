...
class TestFull(unittest.TestCase):
    ...
    def test_full_tosa_MI(self, test_tensor: torch.Tensor):
        self._test_full_tosa_MI_pipeline(self.AddVariableFull(), test_tensor)

    @parameterized.expand(AddVariableFull.test_parameters)
    def test_full_tosa_BI(self, test_tensor: torch.Tensor):
        self._test_full_tosa_BI_pipeline(self.AddVariableFull(), test_tensor, False)

    @parameterized.expand(AddVariableFull.test_parameters)
    def test_full_u55_BI(self, test_tensor: torch.Tensor):
