...
@common.parametrize("test_data", MatMulSingleInput.test_data_generators)
@common.SkipIfNoModelConverter
def test_matmul_vgf_FP_single_input(test_data: input_t1):
    pipeline = VgfPipeline[input_t1](
        MatMulSingleInput(),
        test_data(),
        aten_op_mm,
...
@common.parametrize("test_data", MatMulCombo.test_data_generators)
@common.SkipIfNoModelConverter
def test_matmul_vgf_FP_combo(test_data: input_t1):
    pipeline = VgfPipeline[input_t1](
...
@common.parametrize("test_data", MatMulSingleInput.test_data_generators)
@common.SkipIfNoModelConverter
def test_matmul_vgf_INT_single_input(test_data: input_t1):
    pipeline = VgfPipeline[input_t1](
        MatMulSingleInput(),
        test_data(),
        aten_op_mm,
...
@common.parametrize("test_data", MatMulCombo.test_data_generators)
@common.SkipIfNoModelConverter
def test_matmul_vgf_INT_combo(test_data: input_t1):
    pipeline = VgfPipeline[input_t1](
        MatMulCombo(),
        test_data(),
        aten_op_mm,
