...
######################################################################
# The `ExecuTorch Developer Tools <../dev-tools-overview.html>`__ is a set of tools designed to
# provide users with the ability to profile, debug, and visualize ExecuTorch
# models.
#
# This tutorial will show a full end-to-end flow of how to utilize the Developer Tools.
# Specifically, it will:
#
# 1. Generate the artifacts consumed by the Developer Tools (`ETRecord <../dev-tools-etrecord.html>`__, `ETDump <../dev-tools-etdump.html>`__).
...
# the eager model. This is generated via ``executorch.dev_tools.generate_etrecord``.
#
# ``executorch.dev_tools.generate_etrecord`` takes in an output file path (str), the
...
# from executing a `Bundled Program Model <../dev-tools-bundled-io.html>`__.
#
...
#
#       cd executorch
#       ./examples/dev_tools/build_dev_tools_example_runner.sh
#       cmake-out/examples/dev_tools/dev_tools_example_runner --bundled_program_path="bundled_program.bp"
...
# ---------------------------
#
# ``Inspector`` provides 2 ways of accessing ingested information: `EventBlocks <../dev-tools-inspector#eventblock-class>`__
...
# `Inspector <../dev-tools-inspector.html>`__
...
# ^^^^^^^^^^^^^^^
#
# - `ExecuTorch Developer Tools <../dev-tools-overview.html>`__
# - `ETRecord <../dev-tools-etrecord.html>`__
# - `ETDump <../dev-tools-etdump.html>`__
# - `Inspector <../dev-tools-inspector.html>`__
