...
[CMake](https://cmake.org/) is a robust and versatile build system, primarily
utilized for the ExecuTorch project. Its design facilitates seamless integration
with various other build systems.  Even if you don't use CMake
...
ExecuTorch's CMake build system only cover the pieces of the runtime that are
