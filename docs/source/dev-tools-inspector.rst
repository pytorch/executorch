...
contents of `ETRecord <dev-tools-etrecord.html>`__ and
`ETDump <dev-tools-etdump.html>`__, helping developers get insights about model
...
Please refer to the `e2e use case doc <tutorials/dev-tools-integration-tutorial.html>`__ get an understanding of how to use these in a real world example.
...
.. autofunction:: executorch.dev_tools.Inspector.__init__
...
.. autofunction:: executorch.dev_tools.Inspector.to_dataframe


print_data_tabular
~~~~~~~~~~~~~~~~~~

.. autofunction:: executorch.dev_tools.Inspector.print_data_tabular
...
.. autofunction:: executorch.dev_tools.Inspector.find_total_for_module
...
.. autofunction:: executorch.dev_tools.Inspector.get_exported_program
...
.. autoclass:: executorch.dev_tools.inspector.EventBlock
...
.. autoclass:: executorch.dev_tools.inspector.Event
...
.. code:: bash
    ...
    python3 -m dev_tools.inspector.inspector_cli --etdump_path <path_to_etdump> --etrecord_path <path_to_etrecord>
