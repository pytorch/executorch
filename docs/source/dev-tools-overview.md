...
ExecuTorch has been designed with [productivity](./intro-overview.md) as one of its core objectives and the ExecuTorch Developer Tools enables this through the comprehensive suite of tools it provides users to help them profile, debug, and visualize models that they have onboarded onto ExecuTorch.
...
The ExecuTorch Developer Tools supports the following features:
...
More details are available in the [ETRecord documentation](dev-tools-etrecord.rst) on how to generate and store an ETRecord.
...
More details are available in the [ETDump documentation](dev-tools-etdump.md) on how to generate and store an ETDump from the runtime.
...
More details are available in the [Inspector API documentation](dev-tools-inspector.rst) on how to use the Inspector APIs.
