...
The VGF quantizer supports [Post Training Quantization (PT2E)](https://docs.pytorch.org/ao/stable/pt2e_quantization/pt2e_quant_ptq.html)
and [Quantization-Aware Training (QAT)](https://docs.pytorch.org/ao/stable/pt2e_quantization/pt2e_quant_qat.html).
