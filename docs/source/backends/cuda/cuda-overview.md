...
For a complete working example, see the [CUDA export script](../../../examples/cuda/scripts/export.py).
...
- [Whisper](../../../examples/models/whisper/README.md) — Audio transcription model with CUDA support
- [Voxtral](../../../examples/models/voxtral/README.md) — Audio multimodal model with CUDA support
- [Gemma3](../../../examples/models/gemma3/README.md) — Vision-language model with CUDA support
