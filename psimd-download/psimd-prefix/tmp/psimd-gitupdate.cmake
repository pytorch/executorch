    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/Users/chenlai/tmp_executorch/executorch/psimd-source'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/chenlai/tmp_executorch/executorch/psimd-source'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
