...
#define NUM_CONV_LAYERS 29
 ...
 #define IDMA_BUFFER_SIZE_DRAM0 (48128) // 47 KB for DRAM0
 #define IDMA_BUFFER_SIZE_DRAM1 (48128) // 47 KB for DRAM1
...
static const conv_layer_config_t CONV_LAYER_CONFIGS[] = {
    {
        ...
        // Input tile: 64×27 (edges: 3,3,3,3)
        .in_dim1_size = 64,
        .in_dim1_pitch = 70,
        .in_dim2_size = 27,
        .in_dim2_pitch = 1890,
        ...
        // Buffer sizes (bytes)
        .input_buffer_size = 5670,
        .coeff_buffer_size = 9408,
        .output_buffer_size = 22528,
        ...
        // Tiling: 64 ch/tile × 1 tiles, 11 rows/tile × 3 tiles
        .n_tile_size = 64,
        .n_tiles = 1,
        .n_tile_size_last = 64,
        .height_tiles = 3,
    ...
    },
    {
        ...
        // Buffer sizes (bytes)
        .input_buffer_size = 10368,
        .coeff_buffer_size = 36864,
        .output_buffer_size = 7168,
        .bias_buffer_size = 256,
        .outscale_buffer_size = 128,
        ...
        // Tiling: 64 ch/tile × 1 tiles, 7 rows/tile × 3 tiles
        .n_tile_size = 64,
        .n_tiles = 1,
        .n_tile_size_last = 64,
        .height_tiles = 3,
    ...
    },
    {
        ...
        // Tiling: 256 ch/tile × 1 tiles, 5 rows/tile × 4 tiles
        .n_tile_size = 256,
        .n_tiles = 1,
        .n_tile_size_last = 256,
        .height_tiles = 4,
    ...
    },
    {
        ...
        // Tiling: 128 ch/tile × 1 tiles, 3 rows/tile × 6 tiles
        .n_tile_size = 128,
        .n_tiles = 1,
        .n_tile_size_last = 128,
        .height_tiles = 6,
