...
#define NUM_CONV_LAYERS 29
 ...
 #define IDMA_BUFFER_SIZE_DRAM0 (0) // 0 KB for DRAM0
 #define IDMA_BUFFER_SIZE_DRAM1 (0) // 0 KB for DRAM1
...
static const conv_layer_config_t CONV_LAYER_CONFIGS[] = {
    {
        ...
        // Input tile: 64×67 (edges: 3,3,3,3)
        .in_dim1_size = 64,
        .in_dim1_pitch = 70,
        .in_dim2_size = 67,
        .in_dim2_pitch = 4690,
        ...
        // Buffer sizes (bytes)
        .input_buffer_size = 14070,
        .coeff_buffer_size = 9408,
        .output_buffer_size = 63488,
        ...
        // Tiling: 64 ch/tile × 1 tiles, 31 rows/tile × 2 tiles
        .n_tile_size = 64,
        .n_tiles = 1,
        .n_tile_size_last = 64,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Input tile: 16×17 (edges: 1,1,1,1)
        .in_dim1_size = 16,
        .in_dim1_pitch = 18,
        .in_dim2_size = 17,
        .in_dim2_pitch = 306,
    ...
    },
    {
        ...
        // Tiling: 256 ch/tile × 2 tiles, 2 rows/tile × 1 tiles
        .n_tile_size = 256,
        .n_tiles = 2,
        .n_tile_size_last = 256,
        .height_tiles = 1,
    ...
    },
    {
        ...
        // Tiling: 256 ch/tile × 1 tiles, 15 rows/tile × 2 tiles
        .n_tile_size = 256,
        .n_tiles = 1,
        .n_tile_size_last = 256,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 128 ch/tile × 1 tiles, 15 rows/tile × 2 tiles
        .n_tile_size = 128,
        .n_tiles = 1,
        .n_tile_size_last = 128,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 128 ch/tile × 2 tiles, 2 rows/tile × 4 tiles
        .n_tile_size = 128,
        .n_tiles = 2,
        .n_tile_size_last = 128,
        .height_tiles = 4,
    ...
    },
    {
        ...
        // Tiling: 256 ch/tile × 4 tiles, 2 rows/tile × 2 tiles
        .n_tile_size = 256,
        .n_tiles = 4,
        .n_tile_size_last = 256,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 64 ch/tile × 8 tiles, 2 rows/tile × 2 tiles
        .n_tile_size = 64,
        .n_tiles = 8,
        .n_tile_size_last = 64,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 128 ch/tile × 16 tiles, 2 rows/tile × 1 tiles
        .n_tile_size = 128,
        .n_tiles = 16,
        .n_tile_size_last = 128,
        .height_tiles = 1,
