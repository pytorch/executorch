...
#define NUM_CONV_LAYERS 29
 ...
 #define IDMA_BUFFER_SIZE_DRAM0 (15360) // 15 KB for DRAM0
 #define IDMA_BUFFER_SIZE_DRAM1 (15360) // 15 KB for DRAM1
...
static const conv_layer_config_t CONV_LAYER_CONFIGS[] = {
    {
        ...
        // Input tile: 64×11 (edges: 3,3,3,3)
        .in_dim1_size = 64,
        .in_dim1_pitch = 70,
        .in_dim2_size = 11,
        .in_dim2_pitch = 770,
        ...
        // Tiling: 64 ch/tile × 1 tiles, 3 rows/tile × 11 tiles
        .n_tile_size = 64,
        .n_tiles = 1,
        .n_tile_size_last = 64,
        .height_tiles = 11,
    ...
    },
    {
        ...
        // Tiling: 16 ch/tile × 4 tiles, 2 rows/tile × 8 tiles
        .n_tile_size = 16,
        .n_tiles = 4,
        .n_tile_size_last = 16,
        .height_tiles = 8,
    ...
    },
    {
        ...
        // Tiling: 8 ch/tile × 16 tiles, 2 rows/tile × 4 tiles
        .n_tile_size = 8,
        .n_tiles = 16,
        .n_tile_size_last = 8,
        .height_tiles = 4,
    ...
    },
    {
        ...
        // Tiling: 128 ch/tile × 1 tiles, 3 rows/tile × 3 tiles
        .n_tile_size = 128,
        .n_tiles = 1,
    ...
    },
    {
        ...
        // Tiling: 4 ch/tile × 64 tiles, 2 rows/tile × 2 tiles
        .n_tile_size = 4,
        .n_tiles = 64,
        .n_tile_size_last = 4,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 64 ch/tile × 4 tiles, 2 rows/tile × 2 tiles
        .n_tile_size = 64,
        .n_tiles = 4,
        .n_tile_size_last = 64,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 1 ch/tile × 512 tiles, 2 rows/tile × 1 tiles
        .n_tile_size = 1,
        .n_tiles = 512,
        .n_tile_size_last = 1,
        .height_tiles = 1,
    ...
    },
    {
        ...
        // Tiling: 32 ch/tile × 16 tiles, 2 rows/tile × 1 tiles
        .n_tile_size = 32,
        .n_tiles = 16,
        .n_tile_size_last = 32,
        .height_tiles = 1,
    ...
    },
    {
        ...
        // Tiling: 64 ch/tile × 1 tiles, 5 rows/tile × 4 tiles
        .n_tile_size = 64,
        .n_tiles = 1,
        .n_tile_size_last = 64,
        .height_tiles = 4,
    ...
    },
    {
        ...
        // Tiling: 128 ch/tile × 2 tiles, 2 rows/tile × 8 tiles
        .n_tile_size = 128,
        .n_tiles = 2,
        .n_tile_size_last = 128,
        .height_tiles = 8,
    ...
    },
    {
        ...
        // Tiling: 16 ch/tile × 8 tiles, 2 rows/tile × 8 tiles
        .n_tile_size = 16,
        .n_tiles = 8,
        .n_tile_size_last = 16,
        .height_tiles = 8,
    ...
    },
    {
        ...
        // Tiling: 2 ch/tile × 64 tiles, 2 rows/tile × 4 tiles
        .n_tile_size = 2,
        .n_tiles = 64,
        .n_tile_size_last = 2,
        .height_tiles = 4,
    ...
    },
    {
        ...
        // Tiling: 512 ch/tile × 1 tiles, 8 rows/tile × 1 tiles
        .n_tile_size = 512,
        .n_tiles = 1,
    ...
    },
    {
        ...
        // Tiling: 8 ch/tile × 32 tiles, 2 rows/tile × 4 tiles
        .n_tile_size = 8,
        .n_tiles = 32,
        .n_tile_size_last = 8,
        .height_tiles = 4,
    ...
    },
    {
        ...
        // Tiling: 1 ch/tile × 256 tiles, 2 rows/tile × 2 tiles
        .n_tile_size = 1,
        .n_tiles = 256,
        .n_tile_size_last = 1,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 1024 ch/tile × 1 tiles, 4 rows/tile × 1 tiles
        .n_tile_size = 1024,
        .n_tiles = 1,
    ...
    },
    {
        ...
        // Tiling: 4 ch/tile × 128 tiles, 2 rows/tile × 2 tiles
        .n_tile_size = 4,
        .n_tiles = 128,
        .n_tile_size_last = 4,
        .height_tiles = 2,
    ...
    },
    {
        ...
        // Tiling: 512 ch/tile × 1 tiles, 2 rows/tile × 1 tiles
        .n_tile_size = 512,
        .n_tiles = 1,
        .n_tile_size_last = 512,
        .height_tiles = 1,
    ...
    },
    {
        ...
        // Tiling: 2048 ch/tile × 1 tiles, 2 rows/tile × 1 tiles
        .n_tile_size = 2048,
        .n_tiles = 1,
    ...
    },
    {
        ...
        // Tiling: 2 ch/tile × 256 tiles, 2 rows/tile × 1 tiles
        .n_tile_size = 2,
        .n_tiles = 256,
        .n_tile_size_last = 2,
        .height_tiles = 1,
