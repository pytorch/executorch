...
def create_submodule_from_nodes(
    ...
    # fuse_as_graphmodule creates new placeholder nodes for external inputs.
    # Propagate metadata from the original tagged constant placeholder nodes
    # so that _get_new_signature, arrange_graph_placeholders, and backend
    # preprocessing passes can identify them correctly.
