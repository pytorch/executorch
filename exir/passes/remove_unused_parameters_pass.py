...
def remove_unused_parameters_pass(
    ...
    unused_targets = {spec.target for spec in unused_params.values()}
    _remove_params_recursive(ep.graph_module, unused_targets)
...
def _remove_params_recursive(
    ...
    placeholders_to_remove = [
        ...
        and node.meta.get(INPUT_SPEC_KEY).target in targets_to_remove
    ]
