...
class TestRemoveViewCopy(unittest.TestCase):
    ...
    def test_spec(self) -> None:
        ...
        # 2    call_function  aten_view_copy_default    <function view at 0x7facb871fb50>   (arg0_1, [6, 5])                                    {}
        # 3    call_function  aten_view_copy_default_1  <function view at 0x7facb871fb50>   (arg1_1, [6, 5])                                    {}
        ...
        for node in etpm.exported_program().graph.nodes:
            if node.name == "arg0_1":
                # arg0_1's lifetime is extended through aten_view_copy_default (memory.view) to idx 5
