    ...
    def test_constant_prop_pass_after_delegation(self) -> None:
        class M(torch.nn.Module):
            ...
            def forward(self, query, key, value):
                ...
                return torch.nn.functional.scaled_dot_product_attention(query, key, value, attn_mask=None, dropout_p=0.0, is_causal=True)
        ...
        edge_prog = to_edge(aten_prog, compile_config=EdgeCompileConfig(_check_ir_validity=False, _use_edge_ops=True))
