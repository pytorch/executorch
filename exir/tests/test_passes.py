...
from executorch.exir.passes.replace_custom_ops_with_aten_ops_pass import (
...
class TestPasses(unittest.TestCase):
    ...
    def test_replace_custom_ops_with_aten_ops_pass(self) -> None:
        ...
        edge_prog = to_edge(
            export(pad, (image_tensor, padding), strict=False),
            compile_config=exir.EdgeCompileConfig(_check_ir_validity=False),
        )
        ...
        assert "pad" not in post_transform_nodes
