...
class TestEmit(unittest.TestCase):
    ...
    def test_out(self) -> None:
        ...
        self.assertEqual(
            len(program.execution_plan[0].chains[0].instructions[0].instr_args.args),
            4,  # pyre-ignore[16]
        )
    ...
    def test_model_out(self) -> None:
        ...
        self.assertEqual(
            len(program.execution_plan[0].chains[0].instructions[1].instr_args.args),
            5,  # pyre-ignore[16]
        )
    ...
    def test_emit_cond(self) -> None:
        ...
        for inst in program.execution_plan[0].chains[0].instructions:
            ...
            op = (
                program.execution_plan[0].operators[inst.instr_args.op_index].name
            )  # pyre-ignore[16]
    ...
    def test_emit_map(self) -> None:
        ...
        self.assertEqual(
            op_table[
                ...
                .chains[0]
                .instructions[0]
                .instr_args.op_index  # pyre-ignore[16]
            ].name,
            "aten::sym_size",
        )
        self.assertEqual(
