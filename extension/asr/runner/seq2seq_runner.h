...
/**
 * Configuration for the Seq2Seq ASR transcription loop.
 *
 * max_new_tokens controls the number of tokens generated after the prompt.
 * Temperature controls the randomness of the output.
 */
struct ET_EXPERIMENTAL Seq2SeqConfig {
...
/**
 * Runner that owns a Seq2Seq ASR model encoder + decoder pair exported as a
 * single ExecuTorch module. A good example is Whisper
 ...
 */
class ET_EXPERIMENTAL Seq2SeqRunner {
 public:
  Seq2SeqRunner(
...
using AsrTranscribeConfig ET_DEPRECATED = Seq2SeqConfig;
using AsrRunner ET_DEPRECATED = Seq2SeqRunner;
