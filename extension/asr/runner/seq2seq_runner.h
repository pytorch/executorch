...
/**
 * Configuration for the Seq2Seq transcription loop.
 *
 * max_new_tokens controls the number of tokens generated after the prompt.
 * Temperature controls the randomness of the output.
 */
struct ET_EXPERIMENTAL Seq2SeqTranscribeConfig {
...
/**
 * Runner for encoder-decoder (Seq2Seq) ASR models such as Whisper.
 *
...
// Backward-compatible aliases (deprecated — prefer Seq2Seq* names).
using AsrRunner = Seq2SeqRunner;
using AsrTranscribeConfig = Seq2SeqTranscribeConfig;
