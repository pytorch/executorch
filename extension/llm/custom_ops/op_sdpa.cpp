...
Tensor& custom_sdpa_out(
  ...
  // TensorPtr
  std::array<executorch::aten::DimOrderType, util::kKVDim> sliced_key_dim_order{
      0, 1, 2, 3};
  ...
  std::array<executorch::aten::DimOrderType, util::kKVDim> sliced_value_dim_order{
      0, 1, 2, 3};
  ...
  std::array<executorch::aten::StridesType, util::kKVDim> sliced_value_strides;
  dim_order_to_stride_nocheck(
