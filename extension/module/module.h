...
class Module final {
 public:
   ...
   */
  std::shared_ptr<runtime::Program> program() const {
    return program_;
  }
   ...
   */
  ET_NODISCARD
  runtime::Result<runtime::EValue> get(
      const std::string& method_name,
      const std::vector<runtime::EValue>& input) {
   ...
   */
  ET_NODISCARD
  runtime::Result<runtime::EValue> get(const std::string& method_name) {
   ...
   */
  ET_NODISCARD
  runtime::Result<std::vector<runtime::EValue>> forward(
      const std::vector<runtime::EValue>& input) {
   ...
   * EventTracer is set.
   */
  runtime::EventTracer* event_tracer() const {
