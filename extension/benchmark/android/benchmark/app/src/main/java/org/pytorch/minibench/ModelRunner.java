...
public class ModelRunner {
     ...
     */
    public void runBenchmark(File model, int numWarmupIter, int numIter, List<BenchmarkMetric> results) {
        ...
        List<Double> usedLatencyResults =
                latency.subList(resultSize / 10, resultSize * 9 / 10);
