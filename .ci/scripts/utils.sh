...
download_stories_model_artifacts() {
  ...
  curl -s "https://huggingface.co/karpathy/tinyllamas/resolve/main/stories110M.pt"
  curl -s "https://raw.githubusercontent.com/karpathy/llama2.c/master/tokenizer.model"
