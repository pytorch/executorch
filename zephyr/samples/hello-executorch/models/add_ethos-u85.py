...
#
# This variant lowers the model for Ethos-U85. See the sibling files in this
# directory for the Cortex-M and Ethos-U55 variants.

OUTPUT_PTE = "hello_executorch_ethos-u85.pte"
...
# Export the model to a `.pte` file for Ethos-U85.
...
def main():
    _export_ethosu("ethos-u85-256", OUTPUT_PTE)
