...
public abstract class Tensor {
    ...
    /**
     * Allocates a new direct {@link ByteBuffer} with native byte order with specified
    ...
    /**
     * Allocates a new direct {@link IntBuffer} with native byte order with specified
    ...
    /**
     * Allocates a new direct {@link FloatBuffer} with native byte order with specified
    ...
    /**
     * Allocates a new direct {@link LongBuffer} with native byte order with specified
    ...
    /**
     * Allocates a new direct {@link DoubleBuffer} with native byte order with specified
