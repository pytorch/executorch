...
public class ModelRunner implements LlamaCallback {
    ...
    /**]
     * Helper class to separate between UI logic and model runner logic.
     * Automatically handle generate() request on worker thread.
     * @param modelFilePath
     * @param tokenizerFilePath
     * @param callback
     */
    ModelRunner(String modelFilePath, String tokenizerFilePath, float temperature, ModelRunnerCallback callback) {
