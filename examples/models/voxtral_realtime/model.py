...
class VoxtralRealtimeConfig:
    ...
    backend: str = "xnnpack"  # "xnnpack", "metal", "mlx", or "portable"
...
def load_model(
    ...
    Args:
        ...
        backend: Backend for acceleration ("xnnpack", "metal", "mlx", or "portable").
    """
    _VALID_BACKENDS = ("xnnpack", "metal", "mlx", "portable")
