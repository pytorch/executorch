...
class ModelArgs:
    ...
    attention_multiplier: Optional[float] = None # Scaling factor 1/sqrt(d_k) in attention formula
    norm_eps: float = 1e-5
    ...
    logits_scaling: Optional[float] = None # Scaling factor applied to the logits of model, functioning similarly to a temperature parameter.
    ...
    residual_multiplier: Optional[float] = None # Scaling factor applied to the residual hidden states
