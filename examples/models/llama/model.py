...
class LlamaModel(EagerModelBase):
    def __init__(self, **kwargs):
        ...
        # 1. Using default path locates in examples/models/llama/params
        ...
        try:
            ...
            # pyre-ignore
            from executorch.examples.models.llama import params

            ckpt_dir = Path(
                pkg_resources.resource_filename(
                    "executorch.examples.models.llama", "params"
                )
            )
        except:
            # The 1st way
