...
# Example script for exporting Llama to flatbuffer
...
def build_args_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--checkpoint_dir",
        default=None,
        help="checkpoint directory. Use with a sharded checkpoint, not for Llama 2. Note, checkpoint_dir takes precedence over checkpoint if both are set.",
    )
    ...
    parser.add_argument(
        "--qnn",
        action="store_true",
        help="Delegate llama to qnn backend (Qualcomm), please use it --kv_cahce=True",
    )
