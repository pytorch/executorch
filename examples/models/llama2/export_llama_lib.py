...
from .source_transformation.sdpa import (
    replace_causal_mask,
    replace_kv_cache_with_qnn_kv_cache,
    replace_sdpa_with_custom_op,
    replace_sdpa_with_qnn_sdpa,
...
def _prepare_for_llama_export(modelname: str, args) -> LlamaEdgeManager:
    ...
    if args.use_kv_cache:
        if args.qnn:
            transforms.append(replace_kv_cache_with_qnn_kv_cache)
            transforms.append(replace_sdpa_with_qnn_sdpa)
