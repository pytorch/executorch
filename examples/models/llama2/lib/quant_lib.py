...
def get_qnn_quantizer(args):
    ...
    if quant_config == "8a8w":
        ...
        qnn_quantizer.set_bit16_op_quant_config(get_default_16bit_qnn_ptq_config(act_observer=MinMaxObserver))
    elif quant_config == "16a4w":
        quant_dtype = QuantDtype.use_16a4w
        qnn_quantizer.add_16bit_quant_ops(qnn_quantizer.SUPPORTED_OPS)
        qnn_quantizer.set_bit16_op_quant_config(get_16a4w_qnn_ptq_config(act_observer=MinMaxObserver))
