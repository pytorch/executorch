...
class GPTQQuantHandler(QuantHandler):
    ...
    def get_inputs(
        ...
        task_dict = None  #  lm_eval.tasks.get_task_dict(calibration_tasks)
    ...
    def create_quantized_state_dict(
        ...
        GPTQ_runner = None  # GenericGPTQRunner(
        #            self.mod,
        #            inputs,
        #            blocksize,
        #            percdamp,
...
def quantize(
    ...
    with torch.device("meta"):
        model = None  # Transformer.from_name(checkpoint_path.parent.name)
