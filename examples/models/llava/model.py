...
class Llava(torch.nn.Module):
    def __init__(
        ...
        self.text_model_args = ModelArgs(
            ...
            # use_sdpa_with_kv_cache_op=True, # TODO: enable this, currently there's a bug in the implementation.
            use_hf_rope=True,
        )
        ...
        # use custom op for SDPA. TODO: enable this, currently there's a bug in the implementation.
