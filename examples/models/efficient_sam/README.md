...
Make sure to install the [required dependencies](https://pytorch.org/executorch/main/backends/coreml/coreml-overview.html#development-requirements) for Core ML export.
