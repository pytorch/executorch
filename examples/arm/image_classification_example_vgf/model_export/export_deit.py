...
if __name__ == "__main__":
    argparser = argparse.ArgumentParser(description="Export ViT model for VGF")
    ...
    argparser.add_argument(
        "--output-path",
        type=str,
        default="./deit_quantized_vgf.pte",
    ...
    with torch.no_grad():
        ...
        measure_accuracy(
            exported_program.module(), dataset["test"].take(args.num_test_samples)
        )
