...
find_program(ARM_ZEPHYR_GCC arm-zephyr-eabi-gcc DOC "arm zephyr toolchain location")
if(NOT ARM_ZEPHYR_GCC)
    message(FATAL_ERROR "Arm zephyr toolchain not found on PATH, please be sure to run `./examples/arm/setup.sh --i-agree-to-the-contained-eula --user-toolchain-url 'https://github.com/zephyrproject-rtos/sdk-ng/releases/download/v0.17.2/toolchain_linux-x86_64_arm-zephyr-eabi.tar.xz' --user-toolchain-dir 'arm-zephyr-eabi'` followed by `source /home/zephyruser/executorch/examples/arm/ethos-u-scratch/setup_path.sh`")
endif()
