# Copyright 2024 The HuggingFace Inc. team.  # noqa: CPY001
#
...
"""Define Fast Gemma Tokenizer Class."""
...
class GemmaTokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize the GemmaTokenizerFast class."""
        super().__init__(
    ...
    def can_save_slow_tokenizer(self) -> bool:
        """Check if able to save slow tokenizer."""
    ...
    def add_eos_token(self):
        """Tokenizer's add_eos_token property."""
        return self._add_eos_token

    @property
    def add_bos_token(self):
        """Tokenizer's add_bos_token property."""
