...
public:
    ...
    void setOutput(void* buffer, const size_t size, const LLMType type, const float qscale = 0);
...
private:
    ...
    LLMType mTokenEmbOutputType;
    size_t mTokenEmbOutputTypeSize;
    float mTokenEmbQuantScale = 0;
};
