...
void RotaryEmbeddingMasterLut::load(const std::string& sinMasterPath,
    ...
    ET_LOG(Debug, "Begin loading rotary embedding lookup table from provided paths.");
...
void RotaryEmbeddingMasterLut::generate() {
    ...
    ET_LOG(Fatal, "Rotary embedding generator not implemented for %s", getLLMTypeName(kType));
}
