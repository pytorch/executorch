...
class CustomT5Stack(T5Stack):
    ...
    def forward(  # noqa: C901
        ...
        # Relative attention bias calculation does not support friendly to QNN,
        # so we precompute the positional bias as a constant tensor and use it directly here.
        # For decoder: use precomputed decoder_self_attn_position_bias.
        # For encoder: use precomputed encoder_self_attn_position_bias.
        ...
        # Only keep the last seq_length positions for the current input.
