...
from executorch.examples.qualcomm.oss_scripts.llama3.model.static_llama3 import (
    Llama3ForCausalLM,
    Llama3Config,
    Llama3DecoderLayer,
)
...
def compile(args, pte_filename, tokenizer):
    ...
    config = Llama3Config.from_pretrained(args.model_dir)
